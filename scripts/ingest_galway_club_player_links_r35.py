"""Round 35: Wikipedia 2013 Galway SHC scored Match triples (fill thin season past 1000); link Brian Holland→Turloughmore, Damien Fahy→Athenry (strong first+last); Portumna 2013 final XV + Pearses/Clarinbridge/Turloughmore/Mullagh thin fills after AF check; skip HOLD orphans; new unverified HOLD collisions. Data in data/r35/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r35" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:brian-holland", "club:turloughmore"),
        ("player:damien-fahy", "club:athenry"),
        ("player:paul-coen-clarinbridge", "club:clarinbridge"),
        ("player:tomas-flannery-padraig-pearses", "club:padraig-pearses"),
        ("player:niall-hayes-portumna", "club:portumna"),
        ("player:kevin-hayes-portumna", "club:portumna"),
        ("player:michael-dolphin-portumna", "club:portumna"),
        ("player:eanna-mcentee-portumna", "club:portumna"),
        ("player:gary-burke-turloughmore", "club:turloughmore"),
        ("player:donal-reilly-mullagh", "club:mullagh"),
        ("player:michael-ryan-portumna", "club:portumna"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.irishtimes.com/sport/gaelic-games/hurling/portumna-lift-galway-shc-title-with-victory-over-loughrea-on-poignant-day-1.1576061",
            "https://archive.connachttribune.ie/dervan-and-coone-goals-steer-mullagh-to-success-556/",
            "https://www.galwaygaa.ie/history/2003-roll-of-honour-football-hurling/",
            "http://www.padraigpearsesgalway.com/intermediate-final-2010/",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r35: Wikipedia 2013 SHC scored Match pack (thin season past 1000); Brian Holland→Turloughmore, Damien Fahy→Athenry linked; AF/Fohenagh dense — Portumna 2013 final XV + Pearses/Clarinbridge/Turloughmore/Mullagh thin fills; new HOLDs for spelling/id collisions.",
    }
    ...
    log = {
        "url": "Wikipedia 2013 SHC scored Matches / Brian Holland Turloughmore / Damien Fahy Athenry / Portumna 2013 final XV thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r35",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r35",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r35: AF/Fohenagh panels dense — no weak AF fills. Wikipedia 2013 SHC scored Match pack past 1000; Holland/Fahy links; Portumna 2013 final XV + Pearses/Clarinbridge/Turloughmore/Mullagh thin fills. HOLD orphans skipped.",
        }
        existing = []
