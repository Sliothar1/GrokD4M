"""Round 66: Meelick-Eyrecourt Connacht IHC Final 2025 XV fills (Western People team sheet + Bay FM joint-captain); Jack O'Malley / Mark Collins from CT 2026 PIHC R1; Kilnadeema–Killimor score correction 1-16; Fr Joe Cheevers G4 scored path; 1959 IHC Final Eyrecourt–Newcastle; club-less ~79 stay HOLD; HOLD orphans skipped (no first+last Fr Joe/Claregalway/College Road/Kilrickle/St Coleman's/Cois Fharraige cites). Data in data/r66/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r66" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r66" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.westernpeople.ie/sport/gaa/tooreen-are-walking-on-eyre_arid-78582.html",
            ...
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1957-1959",
            "https://www.galwaydaily.com/sport/gaa-meelick-eyrecourt-into-intermediate-hurling-semis/"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's/Fr Joe Walsh's/Cois Fharraige (no first+last named XV cites). r66: Meelick Connacht IHC Final 2025 XV club-scoped fills + Killimor 1-16 correction + Fr Joe Cheevers G4 scored path + 1959 IHC Eyrecourt final match; club-less ~79 stay HOLD; HOLD orphans skipped; Enda Lawless Carnmore twin + Padraig Breheny / Kerrill Wade / Michael Kelly / Tadgh Haran / Fr Michael Kilkenny HOLD notes.",
    }
    ...
    log = {
        "url": "Meelick Connacht IHC Final 2025 XV fills; CT PIHC R1 Jack O'Malley/Mark Collins; Killimor 1-16 correction; Fr Joe Cheevers G4; 1959 IHC Eyrecourt final; club-less HOLD",
        "date": "2026-09-07",
        "title": "Galway club-player pack r66",
        "publisher": "Western People / Connacht Tribune / Galway Bay FM / Wikipedia / Athenry GAA / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r66",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r66: dense player fills skipped. Meelick Connacht XV fills + Killimor score correction + Fr Joe Cheevers G4 + 1959 Eyrecourt IHC final; club-less HOLD; Fr Joe/Cois/orphans still unnamed.",
        }
        existing = []
