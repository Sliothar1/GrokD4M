"""Round 49: Athenry GAA 1967 U-16/MHC + 1971 U-21 scored path gaps; Kilbeacanty 7s + Junior B/D scored Matches (Kilconieron GAA); Clarinbridge SHC R2 CT score correction; Craughwell+Skehana-MM thin fills; club-less ~79 stay HOLD; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collision notes. Data in data/r49/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r49" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r49" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaybayfm.ie/sports/2026-kilbeacanty-7s-interviews-222518",
            "https://www.connachttribune.ie/sport/clarinbridge-maintain-winning-start-to-galway-shc-with-victory-over-cappataggle-8936474",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r49: Athenry 1967 U-16 + MHC scored path + 1971 U-21 North/Final gaps; Kilbeacanty 7s + Junior B/D scored Matches (Kilconieron GAA); Clarinbridge R2 score correction (CT 2-19); Craughwell+Skehana-MM thin fills; club-less ~79 stay HOLD (collision notes); AF/Fohenagh dense skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "Athenry 1967/1971 scored gaps / Kilbeacanty 7s + Junior B/D scored / Clarinbridge R2 CT correction / Craughwell+Skehana-MM thin fills / HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r49",
        "publisher": "Athenry GAA / Kilconieron GAA / Galway Bay FM / Connacht Tribune / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r49",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r49: dense - skipped. Athenry 1967/1971 scored gaps; Kilbeacanty 7s + Junior B/D; Clarinbridge R2 CT correction; Craughwell+Skehana-MM thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
