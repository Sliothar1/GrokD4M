#!/usr/bin/env python3
"""Round 10: club-less Galway Bay FM/GAA links + PIHC/IHC score gaps + Salthill/Bearna/Cussane shells; AF first. Data in data/r10/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r10" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaybayfm.ie/sports/galway-minor-team-announced-49173",
            "https://www.galwaybayfm.ie/sports/county-intermediate-hurling-championship-reports-227441",
            ...
            "https://www.connachttribune.ie/sport/county-champions-loughrea-pushed-all-the-way-by-moycullen-in-galway-shc-8945197",
            ...
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1960-1963",
            "https://www.rte.ie/sport/gaa/2018/0919/994767-five-galway-all-ireland-winners-in-minor-team-of-2018/",
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's). Cussane CLEARED via Athenry GAA 1963 first+last XV. r10: club-less 2018 MHC/SHC links; 2026 PIHC R1 + 2019 IHC knockout scored matches; Salthill/Bearna/Cussane shell squads; AF priority companion PIHC scores.",
    }
    ...
    log = {
        "url": "Galway Bay FM 2018 MHC + 2026 PIHC + AI Junior SF + Independent Salthill + Connacht Tribune + Wikipedia 2019 IHC/AIJH + Athenry GAA Cussane",
        "date": "2026-09-06",
        "title": "Galway club-player pack r10",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r10",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF r10: 2016 IHC + 2026 PIHC scored matches; shell squads on Salthill/Bearna unverified pending Archivist. No new AF Kelly stamps (collision HOLD).",
        }
        existing = []
