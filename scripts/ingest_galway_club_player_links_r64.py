"""Round 64: AF orphan score fills (PIHC R1 2-17/2-13; 2023 SB QF/SF/Final draw); Ballinderreen-Rahoon PIHC score correction 1-18 multi-source; U16 A1 Cup Final Clarinbridge-Skehana + U20 A1 Final Carnmore-Castlegar; club-less ~79 stay HOLD; skip dense AF/Fohenagh player fills; skip HOLD orphans; Kerrill Wade / Michael Kelly / Tadgh Haran / Enda Lawless / Padraig Breheny / Fr Michael Kilkenny HOLD collision notes. Data in data/r64/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r64" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r64" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaybayfm.ie/sports/ahascragh-fohenagh-1-18-mullagh-2-15-senior-b-hurling-final-report-reaction-146150",
            "https://en.wikipedia.org/wiki/2023_Galway_Senior_Hurling_Championship",
            "https://ballinderreengaa.clubzap.com/results/132528",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-95-205938",
            "https://www.galwaybayfm.ie/sports/carnmore-beat-castlegar-in-county-u20-a1-final-commentary-and-report-202539",
            "https://clarinbridgegaa.clubifyapp.com/results/114222"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan. r64: AF orphan score fills + Ballinderreen-Rahoon 1-18 correction; U16 A1 Cup Final + U20 A1 Final; club-less ~79 stay HOLD; AF dense player fills skipped; HOLD orphans skipped; Kerrill Wade / Michael Kelly / Tadgh Haran / Enda Lawless / Padraig Breheny / Fr Michael Kilkenny HOLD collision notes.",
    }
    ...
    log = {
        "url": "AF orphan score fills; Ballinderreen-Rahoon 1-18 correction; U16 A1 Cup Final; U20 A1 Final Carnmore; club-less HOLD",
        "date": "2026-09-07",
        "title": "Galway club-player pack r64",
        "publisher": "Connacht Tribune / Tuam Herald / Galway Bay FM / Wikipedia / ClubZap / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r64",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r64: dense player fills skipped. AF orphan score fills + Ballinderreen-Rahoon correction; U16 A1 Cup Final + U20 A1 Final; club-less HOLD; Fr Joe/Cois/orphans skipped.",
        }
        existing = []
