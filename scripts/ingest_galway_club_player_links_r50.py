"""Round 50: Galway GAA SHC final score fills (1970/1971/1992) + Wiki 1992 draw/replay; Athenry 1972 U-21/MHC/U-14 scored path gaps; Kilconieron Junior D + youth scored Matches; Ardrahan thin fills (CT SHC R2); club-less ~79 stay HOLD; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collision notes. Data in data/r50/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r50" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r50" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaygaa.ie/stats-galway-senior-hurling-club-finals-1887-2021/",
            "https://en.wikipedia.org/wiki/1992_Galway_Senior_Hurling_Championship",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1972",
            "https://www.kilconierongaaclub.ie/",
            "https://www.connachttribune.ie/sport/athenry-progress-into-galway-shc-quarter-finals-with-victory-over-ardrahan-8941217",
            "https://en.wikipedia.org/wiki/Kerril_Wade",
            "https://www.irishexaminer.com/sport/gaa/arid-30504495.html"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r50: Galway GAA SHC final score fills 1970/1971/1992 + Wiki 1992 draw/replay; Athenry 1972 U-21/MHC/U-14 scored gaps; Kilconieron Junior D + U14/U16/U17B/U20 scored Matches; Ardrahan thin fills (Conor Cosgrove, Eoin Murphy); club-less ~79 stay HOLD (collision notes incl. Kerrill/Kerril Wade); AF/Fohenagh dense skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "GAA SHC final score fills 1970/71/92 + Wiki 1992 draw/replay / Athenry 1972 scored gaps / Kilconieron Junior D+youth scored / Ardrahan thin fills / HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r50",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r50",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r50: dense - skipped. GAA SHC final score fills 1970/71/92; Athenry 1972 scored gaps; Kilconieron Junior D+youth; Ardrahan thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
