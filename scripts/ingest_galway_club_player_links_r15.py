#!/usr/bin/env python3
"""Round 15: Wikipedia/Turloughmore/Tuam Herald/Galway Bay FM club-less links + Wikipedia 2024/2025 scored knockout/relegation matches; Fohenagh/AF-first (1963 team sheet + 2026 PIC XV) + thin Clarinbridge/Pearses/Loughrea/Craughwell/Castlegar/Turloughmore/St Thomas/Athenry/Kilnadeema/Tynagh/Mullagh/Ballinderreen/Kilconieron/Gort fills; HOLD Coen/Kelly/Killilea collisions. Data in data/r15/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r15" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:mullagh", "club:portumna", "club:killimor", "club:kiltormer", "club:sylane", "club:oranmore-maree",
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/Darragh_Coen",
            "https://turloughmoregaa.ie/1963/09/22/county-final-1963/",
            "https://www.tuamherald.ie/2026/08/13/ahascragh-fohenagh-defeat-kinvara-in-opener/",
            "https://www.galwaybayfm.ie/sports/brooks-county-senior-hurling-final-preview-clarinbridge-aiming-to-win-first-title-in-eleven-years-104368",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/2024",
            "https://www.sarsfields-gaa.com/senior-hurling-club",
            "https://www.connachttribune.ie/sport/gaa/all-ireland-final/player-profiles-meet-galway-senior-hurling-team-to-face-limerick-in-all-ireland-final-8808017",
        ],
        "before": {
        ...
        "priority_club_counts_after": {
            ...
            for c in [
                ...
                "club:portumna", "club:carnmore", "club:rahoon", "club:abbeyknockmoy", "club:kilnadeema-leitrim", "club:ballinderreen", "club:killimor", "club:mullagh", "club:loughrea",
            ]
        },
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r15: Fohenagh/AF-first (Turloughmore 1963 Fohenagh XV + Tuam Herald 2026 AF Sean Kelly/Alan Moclair); Wikipedia 2024/2025 scored knockout/relegation matches; club-less links (Hannon/Quinn/Darragh Coen/Callanan); thin Clarinbridge/Pearses/Loughrea/Craughwell/Castlegar/Turloughmore/St Thomas/Athenry/Kilnadeema/Tynagh/Mullagh/Ballinderreen/Kilconieron/Gort fills; HOLD Dara Coen/Noel Kelly/Niall Kelly/Murty Killilea collisions.",
    }
    ...
    log = {
        "url": "Wikipedia/Turloughmore/Tuam Herald/Galway Bay FM club-less + Wikipedia 2024/2025 scored matches + Fohenagh/AF-first fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r15",
        "publisher": "Wikipedia / Turloughmore GAA / Tuam Herald / Galway Bay FM / Athenry GAA / Sarsfields GAA / Connacht Tribune / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r15",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r15: Turloughmore 1963 Fohenagh team sheet (12 new historic) + Tuam Herald 2026 AF Sean Kelly/Alan Moclair unverified. Linked Darragh Coen Clarinbridge (HOLD bare Dara Coen). HOLD Noel/Niall Kelly and Murty Killilea. Skip HOLD orphans.",
        }
        existing = []
