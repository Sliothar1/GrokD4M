"""Round 41: Pre-2008 Galway SHC knockout scored Match triples (2000–2005 QF/SF + 2007/2008/2009 completions) + Connacht Junior Club HC scored finals (JHC gaps); Bearna/Na Forbacha BayFM dual-panel thin fills; club-less ~82 stay HOLD; skip HOLD orphans; new unverified HOLD collisions. Data in data/r41/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r41" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r41" not in note:
    ...
    for clear_pid, clear_club in [
        ("player:tommy-halliday-bearna-na-forbacha", "club:bearna-na-forbacha"),
        ("player:donal-folan-bearna-na-forbacha", "club:bearna-na-forbacha"),
        ("player:ryan-folan-bearna-na-forbacha", "club:bearna-na-forbacha"),
        ("player:charlie-friel-bearna-na-forbacha", "club:bearna-na-forbacha"),
        ("player:ryan-otoole-bearna-na-forbacha", "club:bearna-na-forbacha"),
        ("player:cathal-folan-bearna-na-forbacha", "club:bearna-na-forbacha"),
        ("player:niall-cox-bearna-na-forbacha", "club:bearna-na-forbacha"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/Connacht_Junior_Club_Hurling_Championship",
            "https://hoganstand.com/county/galway/article/index/227280",
            "https://www.galwaybayfm.ie/sports/galway-junior-hurling-team-named-for-new-york-semi-final-152487",
            "https://www.galwaybayfm.ie/sports/galway-development-hurling-squad-face-new-york-this-evening-in-connacht-league-semi-final-128496",
            "https://en.wikipedia.org/wiki/P%C3%A1draig_Brehony",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r41: pre-2008 Galway SHC knockout scored Match pack (2000–2005 QF/SF + 2007 Portumna QF + 2008 Gort SF + 2009 QFs from BayFM) + Connacht Junior Club HC 2006/2007/2008/2011/2014/2015 finals (JHC gaps); club-less ~82 stay HOLD (no new strong multi-source clears; Breheny/Brehony bare rows remain HOLD beside clubbed TAD rows); AF/Fohenagh dense — skipped; Bearna/Na Forbacha BayFM dual-panel thin fills; new HOLD collision notes for Breheny/Haran/Wade/Fahy.",
    }
    ...
    log = {
        "url": "Pre-2008 Galway SHC knockout scored Matches (2000-2005/2007-2009) / Connacht Junior Club HC / Bearna thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r41",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r41",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r41: AF/Fohenagh panels dense — no weak AF fills. Pre-2008 SHC knockouts + Connacht Junior Club HC scored Matches; Bearna/Na Forbacha thin fills. Club-less HOLD; orphans skipped.",
        }
        existing = []
