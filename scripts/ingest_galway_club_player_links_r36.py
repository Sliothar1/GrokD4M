"""Round 36: Wikipedia 2021 Senior B + relegation scored Match triples (fill thin 2021); 2012 knockout scored Matches + 2010 final score; link Brian Murphy→Turloughmore (strong first+last); AF/Fohenagh dense — St Thomas/Loughrea/Pearses/Tynagh/Gort thin fills; skip HOLD orphans; new unverified HOLD collisions. Data in data/r36/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r36" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:brian-murphy", "club:turloughmore"),
        ("player:patrick-skehill-st-thomas", "club:st-thomas"),
        ("player:shane-skehill-st-thomas", "club:st-thomas"),
        ("player:sean-burke-st-thomas", "club:st-thomas"),
        ("player:ger-murray-st-thomas", "club:st-thomas"),
        ("player:anthony-kelly-st-thomas", "club:st-thomas"),
        ("player:johnny-maher-loughrea", "club:loughrea"),
        ("player:kenneth-colleran-loughrea", "club:loughrea"),
        ("player:greg-keary-loughrea", "club:loughrea"),
        ("player:damien-mcclearn-loughrea", "club:loughrea"),
        ("player:eoin-mahony-loughrea", "club:loughrea"),
        ("player:emmett-mahony-loughrea", "club:loughrea"),
        ("player:james-dooley-loughrea", "club:loughrea"),
        ("player:darren-oshaughnessy-turloughmore", "club:turloughmore"),
        ("player:conor-burke-turloughmore", "club:turloughmore"),
        ("player:jimmy-gelston-padraig-pearses", "club:padraig-pearses"),
        ("player:cormac-ward-padraig-pearses", "club:padraig-pearses"),
        ("player:gareth-lally-padraig-pearses", "club:padraig-pearses"),
        ("player:padraig-robinson-tynagh-abbey-duniry", "club:tynagh-abbey-duniry"),
        ("player:brian-regan-gort", "club:gort"),
        ("player:keith-killilea-gort", "club:gort"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/2012_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2010_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2014_Galway_Senior_Hurling_Championship",
            "https://www.advertiser.ie/galway/article/55866/mullagh-and-loughrea-replay-this-sunday-in-kenny-park",
            "https://www.advertiser.ie/galway/article/56075/two-early-goals-stun-mullagh",
            "https://www.irishexaminer.com/sport/gaa/arid-20210871.html",
            "https://www.irishtimes.com/sport/late-cummins-goal-proves-decisive-1.630761",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r36: Wikipedia 2021 Senior B + relegation scored Match pack (thin 2021); 2012 knockout scored Matches + 2010 final score/replay; Brian Murphy→Turloughmore linked; AF/Fohenagh dense — St Thomas/Loughrea/Pearses/Tynagh/Gort thin fills; new HOLDs for spelling/id collisions.",
    }
    ...
    log = {
        "url": "Wikipedia 2021 Senior B scored Matches / 2012 knockout / Brian Murphy Turloughmore / St Thomas Loughrea Pearses thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r36",
        "publisher": "Wikipedia / Galway Advertiser / Irish Examiner / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r36",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r36: AF/Fohenagh panels dense — no weak AF fills. Wikipedia 2021 Senior B + 2012 knockout scored Match packs; Brian Murphy→Turloughmore; St Thomas/Loughrea/Pearses/Tynagh/Gort thin fills. HOLD orphans skipped.",
        }
        existing = []
