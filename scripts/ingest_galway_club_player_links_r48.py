"""Round 48: 2026 PIHC R2/R3 scored Matches (Kilconieron GAA / Mullagh+Ballinderreen ClubZap); Athenry GAA 1968–1969 MHC/U-21/U-16 scored path gaps; Rahoon+Kilconieron+Ballygar thin fills (CT/Tuam Herald); club-less ~79 stay HOLD; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collision notes. Data in data/r48/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r48" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r48" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://mullaghgaa.clubzap.com/results",
            "https://ballinderreengaa.clubzap.com/results",
            ...
            "https://www.tuamherald.ie/2026/08/12/pearses-get-better-of-ballygar/",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r48: 2026 PIHC Round 2+3 scored Matches (Kilconieron GAA; Mullagh+Ballinderreen ClubZap); Athenry 1968–1969 MHC/U-21/U-16 scored gaps; Rahoon/Kilconieron/Ballygar thin fills (CT/Tuam Herald); club-less ~79 stay HOLD; AF/Fohenagh dense skipped; HOLD orphans skipped; new HOLD notes Enda Lawless Carnmore↔ME keeper collision + Joe Keane/Gordon Glynn/Declan Jennings/Aonghus Dervan/Sean Glynn.",
    }
    ...
    log = {
        "url": "2026 PIHC R2/R3 scored Matches / Athenry 1968-1969 scored gaps / Rahoon+Kilconieron+Ballygar thin fills / HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r48",
        "publisher": "Kilconieron GAA / Mullagh ClubZap / Ballinderreen ClubZap / Athenry GAA / Connacht Tribune / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r48",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r48: dense - skipped. 2026 PIHC R2/R3; Athenry 1968-1969 scored gaps; Rahoon/Kilconieron/Ballygar thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
