"""Round 34: Wikipedia 2014 Galway SHC scored Match triples (fill thin season); link Christy Helebert→Ballinderreen, Murty Killilea→Carnmore, Cathal Coen→Clarinbridge, Noel Kelly→Sarsfields (strong first+last); Portumna/Carnmore/Gort/Tommy Larkin's thin fills after AF check; skip HOLD orphans; new unverified HOLD collisions. Data in data/r34/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r34" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:christy-helebert", "club:ballinderreen"),
        ("player:murty-killilea", "club:carnmore"),
        ("player:cathal-coen", "club:clarinbridge"),
        ("player:noel-kelly", "club:sarsfields"),
        ("player:gerry-quinn-gort", "club:gort"),
        ("player:kevin-killilea-carnmore", "club:carnmore"),
        ("player:gareth-heagney-portumna", "club:portumna"),
        ("player:conor-ohare-portumna", "club:portumna"),
        ("player:peter-smith-portumna", "club:portumna"),
        ("player:owen-treacy-portumna", "club:portumna"),
        ("player:eoin-lynch-portumna", "club:portumna"),
        ("player:leo-smith-portumna", "club:portumna"),
        ("player:niall-kelly-tommy-larkins", "club:tommy-larkins"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaybayfm.ie/sports/galway-and-offaly-in-rare-u21-hurling-championship-clash-47033",
            "https://www.galwaygaa.ie/history/roll-of-honour-1980-1999-hurling-football/",
            "https://www.independent.ie/sport/gaelic-games/hurling/clarinbridge-now-rule-in-connacht/26068228.html",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r34: Wikipedia 2014 SHC scored Match pack (thin season); Christy Helebert→Ballinderreen, Murty Killilea→Carnmore, Cathal Coen→Clarinbridge, Noel Kelly→Sarsfields linked; AF/Fohenagh dense — Portumna 2014 final XV + Carnmore/Gort/Tommy Larkin's thin fills; new HOLDs for spelling/id collisions.",
    }
    ...
    log = {
        "url": "Wikipedia 2014 SHC scored Matches / Christy Helebert Ballinderreen / Murty Killilea Carnmore / Cathal Coen Clarinbridge / Noel Kelly Sarsfields",
        "date": "2026-09-06",
        "title": "Galway club-player pack r34",
        "publisher": "Wikipedia / HoganStand / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r34",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r34: AF/Fohenagh panels dense — no weak AF fills. Wikipedia 2014 SHC scored Match pack; Helebert/Killilea/Coen/Kelly links; Portumna/Carnmore/Gort/Tommy Larkin's thin fills. HOLD orphans skipped.",
        }
        existing = []
