"""Round 24: Wikipedia/RoH/BayFM club-less links (Peter Huban Kinvara; Johnny O'Loughlin Loughrea; Pat Diviney Beagh; Brian Mahoney Loughrea clearing spelling HOLD); Wikipedia 2016 scored Senior A/B relegation + SB playoffs + Round 5 Match triples; Fohenagh/AF-first club-scoped Niall Burke; thin Micheál Breathnach Junior 1 2016 fills; skip HOLD orphans; new unverified HOLD collisions (Niall Burke Oranmore vs AF). Data in data/r24/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r24" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:mullagh", "club:portumna", "club:killimor", "club:kiltormer", "club:sylane", "club:oranmore-maree", "club:carnmore", "club:liam-mellows", "club:abbeyknockmoy", "club:an-spideal", "club:micheal-breathnach",
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://en.wikipedia.org/wiki/Peter_Huban",
            ...
            "https://www.galwaybayfm.ie/sports/galway-gaa-club-teams-of-the-2000s-announced-79941",
            "https://web.archive.org/web/20030502010052/http:/www.skynet.ie/~beagh/history.htm",
        ],
        "before": {
        ...
        "priority_club_counts_after": {
            ...
            for c in [
                ...
                "club:portumna", "club:carnmore", "club:rahoon", "club:abbeyknockmoy", "club:kilnadeema-leitrim", "club:ballinderreen", "club:killimor", "club:mullagh", "club:an-spideal", "club:micheal-breathnach", "club:kinvara", "club:beagh", "club:kilnadeema-leitrim", "club:loughrea", "club:mountbellew-moylough", "club:moycullen", "club:ballinasloe", "club:leitrim-galway-historic", "club:ahascragh-historic",
            ]
        },
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r24: club-less Peter Huban->Kinvara; Johnny O'Loughlin->Loughrea; Pat Diviney->Beagh; Brian Mahoney->Loughrea (clears spelling HOLD vs O'Mahony); Wikipedia 2016 relegation/SB playoff/Round 5 scores; AF-first club-scoped Niall Burke; thin Micheál Breathnach J1 2016; HOLD Niall Burke Oranmore vs AF.",
    }
    ...
    log = {
        "url": "Wikipedia/RoH/BayFM club-less + AF-first Niall Burke + thin Breathnach + 2016 relegation/playoff/R5 scores",
        "date": "2026-09-06",
        "title": "Galway club-player pack r24",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r24",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r24: Liam Tully/Liam Cosgrove/Ciaran Cosgrove/Padraig Gavin Irish Examiner 2017 All-Ireland Club IHC final. An Spidéal J1 2013 thin fill; Kilnadeema IHC 2013. Wikipedia 2018-2019 PQF scores. HOLD Luke/Liam Cosgrove; Michael Donohue. HOLD orphans skipped.",
        }
        existing = []
