"""Round 39: 2007/2008 Galway SHC knockout scored Match triples (pre-2010 priority) + Connacht IHC 2008/2009 finals (IHC gaps); Cappataggle 2008 RoH + Craughwell/Mellows/Portumna thin fills; club-less stay HOLD; skip HOLD orphans; new unverified HOLD collisions. Data in data/r39/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r39" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r39" not in note:
    ...
    for clear_pid, clear_club in [
        ("player:alan-dolan-cappataggle", "club:cappataggle"),
        ("player:padraic-dolan-cappataggle", "club:cappataggle"),
        ("player:david-kenny-cappataggle", "club:cappataggle"),
        ("player:brian-byrnes-cappataggle", "club:cappataggle"),
        ("player:michael-broderick-cappataggle", "club:cappataggle"),
        ("player:declan-cormican-cappataggle", "club:cappataggle"),
        ("player:daniel-loughnane-cappataggle", "club:cappataggle"),
        ("player:jonathan-shaughnessy-cappataggle", "club:cappataggle"),
        ("player:alan-callanan-craughwell", "club:craughwell"),
        ("player:ciaran-ryan-portumna", "club:portumna"),
        ("player:shane-minton-liam-mellows", "club:liam-mellows"),
        ("player:mickey-grealish-liam-mellows", "club:liam-mellows"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.advertiser.ie/galway/article/2322/portumna-still-on-course",
            "https://www.advertiser.ie/galway/article/2868/first-half-goal-flurry-kills-off-mellows-challenge",
            "https://www.advertiser.ie/galway/article/3733/impossible-to-look-past-portumna-on-sunday",
            "https://www.advertiser.ie/Galway/article/45053/healy-points-the-way-for-craughwell",
            "https://www.hoganstand.com/article/index/84386",
            "https://athenry.org/record/st-marys-gaa-club-sept-2007-3819/",
            "https://www.irishtimes.com/sport/portumna-to-meet-kinvara-1.970558",
            "https://en.wikipedia.org/wiki/2008%E2%80%9309_All-Ireland_Intermediate_Club_Hurling_Championship",
            "https://en.wikipedia.org/wiki/Connacht_Intermediate_Club_Hurling_Championship",
            "https://www.galwaygaa.ie/history/2008-roll-of-honour/",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r39: 2007/2008 Galway SHC knockout scored Match pack (pre-2010) + Connacht IHC 2008 Cappataggle–Four Roads / 2009 Tynagh–Ballyhaunis; club-less ~82 stay HOLD (Alan Leech Kinvara MotM 2007 still dual-club; Gordon Glynn Loughrea 2008 goal vs Gordan Glynn Kiltormer twin); AF/Fohenagh dense — Cappataggle 2008 RoH + Craughwell Alan Callanan club-scoped + Mellows/Portumna thin fills; new HOLDs for Gordon Glynn/Stephen Creaven dual-stamp collisions.",
    }
    ...
    log = {
        "url": "2007/2008 Galway SHC knockout scored Matches / Connacht IHC 2008-09 / Cappataggle 2008 RoH + Craughwell-Mellows-Portumna thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r39",
        "publisher": "Galway Advertiser / Hogan Stand / Athenry.org / Irish Times / Galway GAA RoH / Wikipedia / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r39",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r39: AF/Fohenagh panels dense — no weak AF fills. 2007/2008 Galway SHC knockout + Connacht IHC 2008/2009 scored Matches; Cappataggle/Craughwell/Mellows/Portumna thin fills. Club-less HOLD; orphans skipped.",
        }
        existing = []
