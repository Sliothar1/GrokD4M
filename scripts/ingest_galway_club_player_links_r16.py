"""Round 16: Galway GAA/Irish Examiner/Athenry GAA/Tuam Herald club-less links + Wikipedia 2024/2025 scored group/knockout/Senior B matches; Fohenagh/AF-first (Kinvara opener opposition fills after AF) + thin Turloughmore/Sarsfields/Ardrahan/Oranmore/Mellows/Beagh/Clarinbridge/Castlegar/Gort/Kilconieron/Cappataggle/Portumna/Tommy Larkins fills; HOLD Martin Donoghue/Gerry Kelly/John Murphy/Michael Helebert/Brian Cunningham/Brian Holland collisions. Data in data/r16/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r16" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.irishexaminer.com/sport-columnists/arid-20210397.html",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1983",
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r16: club-less links (Aidan Staunton/John Goode Kiltormer; Shane McClaran Killimor; Luke Glynn Athenry); Wikipedia 2024 Group 3/4 + Senior B + 2025 R3 scored matches; Tuam Herald Kinvara XV fills after AF; thin Turloughmore/Sarsfields/Ardrahan/Oranmore/Mellows/Beagh/Clarinbridge/Castlegar/Gort/Kilconieron/Cappataggle/Portumna/Tommy Larkins fills; HOLD Martin Donoghue/Gerry Kelly/John Murphy/Michael Helebert/Brian Cunningham/Brian Holland collisions.",
    }
    ...
    log = {
        "url": "Galway GAA/Irish Examiner/Athenry/Tuam Herald club-less + Wikipedia 2024/2025 scored matches + Kinvara/AF-adjacent thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r16",
        "publisher": "Wikipedia / Galway GAA / Irish Examiner / Athenry GAA / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r16",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r16: Tuam Herald 2026 AF vs Kinvara Kinvara XV fills (AF panel already dense). Linked Staunton/Goode Kiltormer, McClaran Killimor, Luke Glynn Athenry. HOLD Martin Donoghue and Kelly/Murphy/Helebert/Cunningham/Holland collisions. Skip HOLD orphans.",
        }
        existing = []
