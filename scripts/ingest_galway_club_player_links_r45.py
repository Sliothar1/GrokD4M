"""Round 45: Pre-1977 Galway SHC knockout scored Match triples (1967–1976 Athenry path) + 2025 Junior B/C/E finals + 2026 Div3 League final; Gerry Kelly->Athenry multi-source clear; Sylane thin fills; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collisions. Data in data/r45/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r45" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r45" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1967",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1968",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1971",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1972",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1974",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1975",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1976",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r45: pre-1977 Galway SHC knockout scored Matches (1967 R1 + 1968 + 1971 R1 + 1972 R1 + 1974 QF/SF + 1975 R1 + 1976 R1 from Athenry GAA) + 2025 Junior B/C/E finals + 2026 Div3 League final; club-less: Gerry Kelly multi-source clear to Athenry; remaining ~79 stay HOLD; AF/Fohenagh dense - skipped; Sylane thin fills (Keane/Fleming/Ronan/Lardner/Igoe/Mahon/Furey/Conor Newell); new HOLD collision notes for Padraig Breheny/Padraic Brehony/Shane Maloney/Liam Shiels/Ned Campbell/Tom Donohue.",
    }
    ...
    log = {
        "url": "Pre-1977 Galway SHC knockouts (1967-1976) / 2025 Junior B/C/E finals / 2026 Div3 League final / Sylane thin fills / Kelly Athenry clear",
        "date": "2026-09-07",
        "title": "Galway club-player pack r45",
        "publisher": "Athenry GAA / Galway Bay FM / Tuam Herald / Connacht Tribune / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r45",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r45: AF/Fohenagh panels dense - skipped. Pre-1977 SHC knockouts + Junior B/C/E + Div3 final; Sylane thin fills; Kelly->Athenry clear. Club-less HOLD; orphans skipped.",
        }
        existing = []
