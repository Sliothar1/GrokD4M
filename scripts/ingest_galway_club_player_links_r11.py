#!/usr/bin/env python3
"""Round 11: club-less 2020 MHC/2025 SHC links + AF Senior B scored matches + Kinvara/Moycullen/Kilconieron thin fills; AF first. Data in data/r11/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r11" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.advertiser.ie/galway/article/102561/lynskeys-minor-hurlers-do-the-business-in-style",
            "https://www.the42.ie/galway-kilkenny-all-ireland-minor-final-4189660-Aug2018/",
            "https://www.gaa.ie/hurling/news/electric-ireland-announce-2020-minor-hurling-team-of-the-year",
            "https://www.galwaybayfm.ie/sports/hurling-six-galway-players-in-2020-minor-team-of-the-year-96793",
            ...
            "https://www.galwaybayfm.ie/sports/kinvara-vs-tynagh-abbey-duniry-intermediate-hurling-final-preview-with-kinvara-joint-manager-michael-helebert-180230",
            "https://www.clarinbridgegaa.ie/articles/59255",
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r11: AF-first 2025 Senior B scored matches; club-less 2020 MHC + 2025 SHC links; Kinvara/Moycullen/Kilconieron/Ballinderreen thin fills; HOLD Kelly/Thomas/Donoghue collisions.",
    }
    ...
    log = {
        "url": "GBFM 2020 MHC + Advertiser 2018 + MOTY + Wikipedia 2025 SHC + Tuam Herald 2026 AF/Kinvara + GBFM 2024 IHC",
        "date": "2026-09-06",
        "title": "Galway club-player pack r11",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r11",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF r11: 2025 Senior B scored group+SF; Tuam Herald 2026 PIHC unverified Conor Kelly/Jack Finnerty/Aaron Moclair (disambiguated). Bare Kelly collisions HOLD.",
        }
        existing = []
