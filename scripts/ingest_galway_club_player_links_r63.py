"""Round 63: correct 2025 SHC SF Loughrea–Turloughmore published score (1-17/0-15 multi-source); Wikipedia 1899/1900 single-season status fill; U16 A1 Cup SF + A1 Shield Final + G4 SF scored triples (Bay FM results-205361); thin Army fills Vin Baston + Joe Young; club-less ~79 stay HOLD; skip dense AF/Fohenagh player fills; skip HOLD orphans; Michael Kelly / Fr Michael Kilkenny / Enda Lawless / Tadgh Haran HOLD collision notes. Data in data/r63/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r63" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r63" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.the42.ie/gaa-results-10-6847970-Oct2025/",
            "https://www.galwaybayfm.ie/gaa/the-weekend-galway-gaa-club-results-205361",
            "https://www.hoganstand.com/Article/Index/338221",
            "https://en.wikipedia.org/wiki/Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/Vin_Baston",
            "https://en.wikipedia.org/wiki/Joe_Young_(dual_player)",
            "https://www.galwaybayfm.ie/sports/galway-gaa-mourns-the-passing-of-1956-all-ireland-winner-colonel-joe-young-136261"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan. r63: Loughrea SF score correction 1-17/0-15; Wikipedia 1899/1900 single-season status; U16 A1 Cup SF + Shield Final + G4 SF; thin Army Vin Baston + Joe Young; club-less ~79 stay HOLD; AF dense fills skipped; HOLD orphans skipped; Michael Kelly / Fr Michael Kilkenny / Enda Lawless / Tadgh Haran HOLD collision notes.",
    }
    ...
    log = {
        "url": "2025 SHC SF Loughrea score correction; 1899 single-season status; U16 A1 Cup/Shield + G4 SF; Army Vin Baston + Joe Young; club-less HOLD",
        "date": "2026-09-07",
        "title": "Galway club-player pack r63",
        "publisher": "The42 / Galway Bay FM / HoganStand / Wikipedia / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r63",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r63: dense player fills skipped. Loughrea SF score correction; U16 scored triples; thin Army Vin Baston + Joe Young; club-less HOLD; Fr Joe/Cois/orphans skipped.",
        }
        existing = []
