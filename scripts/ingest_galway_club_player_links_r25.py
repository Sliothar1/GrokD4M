"""Round 25: RoH/Advertiser/Wikipedia club-less links (Justin Donnelly/Shane Tierney/Ronan Farrell/Paddy Cormican/Gordan Glynn Kiltormer; David Greene Ardrahan; Michael John Quinn Athenry); Wikipedia 2017 scored AF Senior B + relegation/SB playoff/PQF Match triples; AF-first Emmet Brennan; thin Meelick/Eyrecourt Minor B 2016 fills; skip HOLD orphans; new unverified HOLD collisions (Niall Flemming MHC vs Niall Fleming Meelick). Data in data/r25/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r25" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaygaa.ie/history/2001-roll-of-honour-football-hurling/",
            ...
            "https://www.advertiser.ie/galway/article/1860/mellows-storm-into-quarter-finals",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r25: club-less Justin Donnelly/Shane Tierney/Ronan Farrell/Paddy Cormican/Gordan Glynn->Kiltormer; David Greene->Ardrahan; Michael John Quinn->Athenry; Wikipedia 2017 AF Senior B + relegation/SB playoff/PQF scores; AF-first Emmet Brennan; thin Meelick/Eyrecourt Minor B 2016; HOLD Niall Flemming MHC vs Niall Fleming Meelick.",
    }
    ...
    log = {
        "url": "RoH/Advertiser/Wikipedia club-less + AF-first Emmet Brennan + thin Meelick + 2017 AF SB/relegation/playoff/PQF scores",
        "date": "2026-09-06",
        "title": "Galway club-player pack r25",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r25",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r25: Emmet Brennan Wikipedia 2017 SHC Senior B. Meelick/Eyrecourt Minor B 2016 thin fill. Wikipedia 2017 AF SB + relegation/SB playoff/PQF scores. HOLD Niall Flemming vs Fleming Meelick; Gordon Glynn vs Gordan Kiltormer. HOLD orphans skipped.",
        }
        existing = []
