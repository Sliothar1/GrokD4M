"""Round 28: Examiner/Advertiser/Carnmore.net Declan O'Brien→Carnmore; RoH 2019 Ciaran O'Donovan→Athenry; Wikipedia 2024 AF Senior B scored Match triples + relegation/replay + 2020 SB r2; AF-first RoH 2009 Anthony Kelly; Carnmore/Ballygar/Clarinbridge thin fills; skip HOLD orphans; new unverified HOLD collisions (Ronal vs Ronan Killilea; Sean vs Sam McArdle). Data in data/r28/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r28" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:declan-obrien", "club:carnmore"),
        ("player:ciaran-odonovan", "club:athenry"),
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.irishexaminer.com/sport/gaa/arid-10051530.html",
            "http://www.advertiser.ie/galway/article/60669/loughrea-in-fine-fettle-as-hurling-championship-gets-under-way",
            "https://web.archive.org/web/20120820033902/http://www.carnmore.net/history.php",
            "https://www.galwaygaa.ie/history/2019-roll-of-honour-hurling-football/",
            ...
            "https://www.galwaygaa.ie/history/2018-roll-of-honour-hurling-football/",
            "https://www.galwaygaa.ie/history/2012-hurling-football-roll-of-honour/",
            ...
            "https://www.connachttribune.ie/sport/carnmores-character-is-critical-to-semis-success-5576816",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r28: Declan O'Brien->Carnmore; Ciaran O'Donovan->Athenry; Wikipedia 2024 AF SB + relegation/replay + 2020 SB r2; AF-first Anthony Kelly RoH 2009; thin Carnmore/Ballygar/Clarinbridge; HOLD Ronal Killilea vs Ronan Carnmore; Sean McArdle vs Sam Clarinbridge.",
    }
    ...
    log = {
        "url": "Examiner/RoH/Wikipedia club-less + AF-first RoH 2009 + 2024/2020 AF scores",
        "date": "2026-09-06",
        "title": "Galway club-player pack r28",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r28",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r28: Anthony Kelly RoH 2009 Junior C. Wikipedia 2024 AF SB group + relegation/replay + 2020 SB r2. Carnmore/Ballygar/Clarinbridge thin fills. HOLD Ronal/Ronan Killilea; Sean/Sam McArdle. HOLD orphans skipped.",
        }
        existing = []
