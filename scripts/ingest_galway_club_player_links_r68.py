"""Round 68: Claregalway orphan break (Tom Ruane 1910–1916 parish hurling captain); AF-first Fohenagh 1959/1960 SHC captain stamps (Martin Glynn/Marty Glynn + Tony O'Gorman); Billy Duffy → Meelick-Eyrecourt; club-less ~79 stay HOLD; remaining HOLD orphans (Kilrickle/Fr Joe/Eyrecourt/Cois/St Coleman's). Data in data/r68/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r68" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r68" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://en.wikipedia.org/wiki/Tom_Ruane",
            "https://www.carnmoregaa.net/about",
            "https://www.readkong.com/page/turloch-naoimh-galway-gaa-6533804",
            "https://en.wikipedia.org/wiki/Billy_Duffy_(hurler)",
            "https://hoganstand.com/county/galway/article/index/51276",
        ...
        "orphan_note": "Remaining HOLD orphans: Eyrecourt/Kilrickle/St Coleman's/Fr Joe Walsh's/Cois Fharraige (no first+last named XV cites). r68: Claregalway orphan broken via Tom Ruane 1910–1916 parish hurling captain; AF Fohenagh 1959/1960 SHC captains stamped; Billy Duffy → Meelick-Eyrecourt; club-less ~79 stay HOLD.",
    }
    ...
    log = {
        "url": "Claregalway Tom Ruane 1910–1916 hurling captain orphan break; AF Fohenagh 1959/1960 SHC captain stamps; Billy Duffy Meelick-Eyrecourt; club-less HOLD",
        "date": "2026-09-10",
        "title": "Galway club-player pack r68",
        "publisher": "Wikipedia / Carnmore GAA / Galway GAA programme (readkong) / HoganStand / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r68",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r68: programme captain roll stamps Martin Glynn/Marty Glynn (1959) + Tony O'Gorman (1960) on Fohenagh historic SHC finals; Claregalway Tom Ruane orphan break; Billy Duffy Meelick-Eyrecourt; club-less HOLD; remaining HOLD orphans unnamed.",
        }
        existing = []
