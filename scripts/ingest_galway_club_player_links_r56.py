"""Round 56: 2018 Toddie Byrne Group B + SF/Final + Justin Cheevers SF/Final + Shield Final + Cois JC Group C; 2022 Toddie Byrne Group 4 + SF + Justin Cheevers SF + Group 3 Fr Joe/Cois path + Michael Cusacks G2; thin-club fills Killimordaly (Aaron McDonagh, Shane Monaghan, Gary McDonagh, Brian Concannon club-scoped twin, Ronan Brett, Owen Earls) + Portumna (Jamie Hogan); prefer Fr Joe/Cois (matches; no first+last named players); club-less ~79 stay HOLD; skip dense AF/Fohenagh; skip HOLD orphans; new unverified HOLD collision notes. Data in data/r56/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r56" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r56" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2018-feile-na-ngael",
            "https://www.galwaybayfm.ie/sports/2018-hurling-feile-results-fixtures-44856",
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2022-feile-na-ngael",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-17th-april-2022-111862",
            "https://en.wikipedia.org/wiki/2025_Galway_Senior_Hurling_Championship",
            "http://www.padraigpearsesgalway.com/2025-senior-cship-round-2/",
            "https://www.connachttribune.ie/sport/ardrahan-edge-past-determined-killimordaly-in-galway-shc-opener-8917893"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan — 2018 Cois JC group + 2022 Fr Joe/Cois scored path added but no first+last named players published for either club. r56: 2018 Toddie Byrne Group B/SF/Final + Justin Cheevers SF/Final/Shield Final + Cois group; 2022 Toddie Byrne G4/SF + Justin Cheevers SF + Fr Joe/Cois G3; Killimordaly+Portumna thin fills; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2018 Toddie Byrne/JC/Shield + Cois group; 2022 Toddie Byrne G4/SF + JC SF + Fr Joe/Cois G3; Killimordaly/Portumna thin fills; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r56",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r56",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r56: dense player fills skipped. 2018 Toddie Byrne/JC + Cois group; 2022 Toddie Byrne G4/SF + JC SF + Fr Joe/Cois G3; Killimordaly/Portumna thin fills; club-less HOLD; Fr Joe+Cois still orphan (no named players); orphans skipped.",
        }
        existing = []
