"""Round 20: Wikipedia 2015/2016 SHC club-less score links + Galway GAA RoH; Wikipedia 2015/2016 scored knockout matches; Fohenagh/AF-first (Ahascragh Minor C 1989) + thin Mountbellew/Skehana-orphan/Ballinasloe/Moycullen/Annaghdown/Leitrim fills; skip HOLD orphans unless first+last (Skehana 1989 U-21); new unverified + HOLD collisions (Don Reilly, Noel McDonagh, Gordan Glynn). Data in data/r20/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r20" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://en.wikipedia.org/wiki/2015_Galway_Senior_Hurling_Championship",
            ...
            "https://www.galwaygaa.ie/history/2015-club-football-hurling-roll-of-honour/",
        ],
        "before": {
        ...
        "priority_club_counts_after": {
            ...
            for c in [
                ...
                "club:portumna", "club:carnmore", "club:rahoon", "club:abbeyknockmoy", "club:kilnadeema-leitrim", "club:ballinderreen", "club:killimor", "club:mullagh", "club:loughrea", "club:mountbellew-moylough", "club:moycullen", "club:ballinasloe", "club:leitrim-galway-historic", "club:ahascragh-historic",
            ]
        },
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (Skehana filled r20 via RoH 1989 U-21 first+last). r20: club-less Wikipedia 2013-2016 SHC score links (Stephen Page/Kevin Huban/Eugene Gorman Tommy Larkin's; Kevin Brady/Kevin Keane Castlegar; Keith Kilkenny Kiltormer; Ronan Badger Turloughmore; Ger O'Halloran Craughwell; Darragh O'Donoghue Kilnadeema-Leitrim); Wikipedia 2015/2016 scored QF/SF/Final-draw matches; Fohenagh/AF-first Ahascragh Minor C 1989; thin Mountbellew/Ballinasloe/Moycullen/Annaghdown/Leitrim fills; HOLD Don Reilly/Noel McDonagh/Gordan Glynn collisions (plus prior holds).",
    }
    ...
    log = {
        "url": "Wikipedia 2013-2016 SHC club-less scores + RoH Fohenagh/AF-first + Skehana orphan fill + thin clubs + 2015/2016 scored knockout",
        "date": "2026-09-06",
        "title": "Galway club-player pack r20",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r20",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r20: Ahascragh Minor C 1989 historic fills first. Wikipedia 2015/2016 scored knockout. HOLD Don Reilly/Noel McDonagh/Gordan Glynn. Skehana orphan filled via RoH 1989 U-21 first+last.",
        }
        existing = []
