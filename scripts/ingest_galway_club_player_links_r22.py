"""Round 22: Wikipedia/Advertiser/RoH club-less links (Donie Fox Carnmore; Rory Foy Ballinderreen; John Hughes Liam Mellows; P J Burke Abbeyknockmoy); Wikipedia 2020-2021 scored knockout Match triples; Fohenagh/AF-first (Ross Hannon); thin Killimor 1984 / Abbeyknockmoy 1985+1988 / Kilconieron 1993 / Oranmore-Maree 1980 fills; skip HOLD orphans (Claregalway, College Road, Eyrecourt, Kilrickle, St Coleman's); new unverified + HOLD collisions (Donal Fox, Martin Kelly, Michael Kelly). Data in data/r22/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r22" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:mullagh", "club:portumna", "club:killimor", "club:kiltormer", "club:sylane", "club:oranmore-maree", "club:carnmore", "club:liam-mellows", "club:abbeyknockmoy",
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.advertiser.ie/galway/article/1756/clarenbridge-can-push-portumna-all-the-way",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r22: club-less Donie Fox->Carnmore; Rory Foy->Ballinderreen; John Hughes->Liam Mellows; P J Burke->Abbeyknockmoy; Wikipedia 2020-2021 scored PQF/QF/SF matches; Fohenagh/AF-first Ross Hannon; thin Killimor IHC 1984 / Abbeyknockmoy / Kilconieron / Oranmore-Maree fills; HOLD Donal Fox / Martin Kelly / Michael Kelly collisions (plus prior holds).",
    }
    ...
    log = {
        "url": "Wikipedia/RoH/Advertiser club-less + AF-first + thin clubs + 2020-2021 scored knockout",
        "date": "2026-09-06",
        "title": "Galway club-player pack r22",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r22",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r22: Ross Hannon Wikipedia 2020 AF scores first. Killimor/Abbeyknockmoy/Kilconieron/Oranmore-Maree thin fills. Wikipedia 2020-2021 scored knockout. HOLD Donal Fox/Martin Kelly/Michael Kelly. HOLD orphans skipped.",
        }
        existing = []
