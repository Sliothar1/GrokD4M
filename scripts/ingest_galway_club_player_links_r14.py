#!/usr/bin/env python3
"""Round 14: Wikipedia/Balls.ie/Clarinbridge/Galway GAA club-less links + Wikipedia 2024 scored group/relegation/Senior B matches; Fohenagh/AF-first + thin Killimor/Cappataggle/Athenry/Ballinderreen/Portumna fills; HOLD Coen/Mannion/Regan/Fahey collisions. Data in data/r14/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r14" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/Tim_Sweeney_(hurler)",
            "https://clarinbridgegaa.ie/articles/42365",
            "https://www.balls.ie/gaa/galway-sensation-scores-the-most-nonchalant-stoppage-time-winner-to-seal-cappataggle-comeback-612510",
            "https://www.galwaygaa.ie/history/2020-2021-roll-of-honour-hurling-football/",
            "https://www.connachttribune.ie/sport/hurling/galway-minor-hurling-squad-announced-ahead-of-leinster-championship-6529877",
            "https://www.galwaydaily.com/sport/galway-gaa-ahascragh-fohenagh-vs-killimor-stage-1/",
            "https://www.tuamherald.ie/2026/07/18/galways-sixth-or-limericks-13th/",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r14: Fohenagh/AF-first (Tim Sweeney + Craig Naughton); Wikipedia 2024 scored group/relegation/Senior B matches; club-less links (Geraghty/Lee/Coen/Concannon/Dolphin/Burke/Coughlan/Hickey); thin Killimor/Cappataggle/Athenry/Ballinderreen/Portumna fills; HOLD Coen/Mannion/Regan/Fahey/Thomas/Kelly collisions.",
    }
    ...
    log = {
        "url": "Wikipedia/Balls.ie/Clarinbridge/Galway GAA club-less + Wikipedia 2024 scored matches + Fohenagh/AF-first fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r14",
        "publisher": "Wikipedia / Balls.ie / Clarinbridge GAA / Galway GAA / Connacht Tribune / Galway Daily / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r14",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF r14: Tim Sweeney historic Fohenagh + Craig Naughton unverified AF. Donal Mannion Cappataggle disambiguated (HOLD AF Donal Mannion overwrite). Bare Coen/Regan/Fahey/Kelly/Thomas collisions HOLD. Skip HOLD orphans.",
        }
        existing = []
