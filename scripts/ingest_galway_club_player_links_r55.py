"""Round 55: 2019 Justin Cheevers Cois Fharraige scored path (SF+Final) + 2019 Toddie Byrne Group B/SF/Final/Shield Final; 2021 Toddie Byrne Shield Fr Joe Walsh's/Cois Fharraige scored path (R1/R3/SF) + 2021 Cup finals/SFs; thin-club fills Mullagh (Liam Curley, Tony Clarke, Eoghan Gaffney, Cathal Kennedy), Kilconieron (Oscar O'Gorman, Peter Martin), Pearses (Eric Ward, Oran Burke); prefer Fr Joe/Cois (matches; no first+last named players); club-less ~79 stay HOLD; skip dense AF/Fohenagh; skip HOLD orphans; new unverified HOLD collision notes. Data in data/r55/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r55" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:skehana", "club:mountbellew-moylough", "club:leitrim-galway-historic", "club:ballinasloe", "club:fohenagh-historic", "club:ahascragh-historic", "club:rahoon", "club:fr-joe-walshs",
    ]:
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r55" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2019-feile-na-ngael",
            "https://www.galwaybayfm.ie/sports/ocean-hygiene-supplies-and-packaging-feile-round-one-results-98168",
            "https://www.galwaybayfm.ie/sports/ocean-hygiene-supplies-packaging-hurling-feile-semi-final-results-98414",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-22nd-august-2021-98506",
            "https://en.wikipedia.org/wiki/2025_Galway_Senior_Hurling_Championship",
            "http://www.padraigpearsesgalway.com/2025-senior-cship-round-1/",
            "https://www.tuamherald.ie/2026/07/16/newell-gives-sylane-the-edge-in-extra-time-thriller-with-pearses/",
            "https://www.galwaydaily.com/sport/gaa-kilconieron-second-half-rally-secures-shield/",
            "https://www.connachttribune.ie/sport/hurling/craughwell-make-it-two-wins-on-the-bounce-in-gritty-affair-5593516",
            ...
            "https://www.galwaygaa.ie/history/2020-2021-roll-of-honour-hurling-football/",
            "https://www.irishexaminer.com/sport/gaa/arid-20451713.html"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan — 2019/2021 scored Féile paths added but no first+last named players published for either club. r55: 2019 Cois Cheevers path + 2021 Fr Joe/Cois Shield path; Mullagh+Kilconieron+Pearses thin fills; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2019 Cois Cheevers path + 2021 Fr Joe/Cois Shield path; Mullagh/Kilconieron/Pearses thin fills; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r55",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r55",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r55: dense player fills skipped. 2019 Cois Cheevers + 2021 Fr Joe/Cois Shield scored paths; Mullagh/Kilconieron/Pearses thin fills; club-less HOLD; Fr Joe+Cois still orphan (no named players); orphans skipped.",
        }
        existing = []
