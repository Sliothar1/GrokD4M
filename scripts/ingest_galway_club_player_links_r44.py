"""Round 44: Pre-1987 Galway SHC knockout scored Match triples (1977 R1 + 1979 R1/QF + 1980 QF + 1986 play-off/QF) + 1978 SHC final score/replay + Michael Cusacks U20B/Toddie Byrne finals; Alan Leech->Kinvara multi-source clear; Skehana/MM + Michael Cusacks thin fills; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collisions. Data in data/r44/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r44" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r44" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1977",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1979",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1980",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1986",
            "https://en.wikipedia.org/wiki/1978_Galway_Senior_Hurling_Championship",
            "https://www.independent.ie/sport/gaelic-games/hurling/goals-give-portumna-closure-out-of-storm/26326590.html",
            "https://www.galwaybayfm.ie/sports/success-for-corofin-and-kinvara-in-county-finals-commentary-and-reaction-71575",
            "https://www.tuamherald.ie/2026/08/12/strong-start-for-skehana-mountbellew-moylough/",
            "https://www.galwaybayfm.ie/sports/galway-junior-hurling-team-named-for-new-york-semi-final-152487",
            "https://www.galwaybayfm.ie/sports/michael-cusacks-wins-county-u20-b-hurling-title-commentary-and-reaction-202531",
            "https://www.galwaybayfm.ie/sports/michael-cusacks-3-10-loughrea-1-14-toddie-byrne-cup-final-report-and-reaction-with-finbarr-gantley-219404",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r44: pre-1987 Galway SHC knockout scored Matches (1977 R1 + 1979 R1/QF + 1980 QF + 1986 play-off/QF from Athenry GAA) + 1978 SHC final score/replay + Michael Cusacks U20B/Toddie Byrne finals; club-less: Alan Leech multi-source clear to Kinvara; remaining ~80 stay HOLD; AF/Fohenagh dense - skipped; Skehana/MM thin fills (Murphy/Horgan/Lyons/Roche/Lohan/Newell/Flahive) + Sean O'Loughlin Michael Cusacks; new HOLD collision notes for Kerrill Wade/Tadgh Haran/Tom Monaghan/Gordon Glynn/Aodh Davoren/Conor Burke.",
    }
    ...
    log = {
        "url": "Pre-1987 Galway SHC knockouts (1977-1986) / 1978 SHC final+replay / Michael Cusacks finals / Skehana-MM thin fills / Leech Kinvara clear",
        "date": "2026-09-06",
        "title": "Galway club-player pack r44",
        "publisher": "Athenry GAA / Wikipedia / Irish Independent / Galway Bay FM / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r44",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r44: AF/Fohenagh panels dense - skipped. Pre-1987 SHC knockouts + 1978 final/replay + Cusacks finals; Skehana/MM + Cusacks thin fills; Leech->Kinvara clear. Club-less HOLD; orphans skipped.",
        }
        existing = []
