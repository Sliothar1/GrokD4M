"""Round 19: Galway GAA Roll of Honour + Wikipedia/Independent club-less links; Wikipedia 2022 SHC scored knockout matches; Fohenagh/AF-first historic fills + thin Kilnadeema-Leitrim/Mountbellew/Leitrim/Rahoon fills; skip HOLD orphans; new unverified + HOLD collisions (Patrick/Pakie Dervan, Conor McDonagh). Data in data/r19/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r19" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaygaa.ie/history/2000-roll-of-honour-football-hurling/",
            ...
            "https://en.wikipedia.org/wiki/2013_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2014_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/1992_All-Ireland_Senior_Club_Hurling_Championship_final",
            "https://www.independent.ie/sport/gaelic-games/hurling/earls-calls-halt-to-four-roads-journey/28903215.html",
            "https://www.hoganstand.com/county/galway/article/index/56111",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r19: club-less RoH/Independent/Wikipedia/Hogan Stand links (Dervan/Pakie Kiltormer; Pascal Ryan Killimordaly; Sean Corcoran Ballinderreen; Ronan/Shane Walsh Carnmore; Michael Coughlan Craughwell; Paul Madden/Niall Earls/Declan Connolly Killimordaly; Pat Nolan Castlegar; David Hayes/Conor Ryan Kiltormer); Wikipedia 2022 SHC scored PQF/QF/SF matches; Fohenagh/AF historic fills first; thin Kilnadeema-Leitrim/Mountbellew/Leitrim/Rahoon fills; HOLD Patrick Dervan/Conor McDonagh collisions (plus prior holds).",
    }
    ...
    log = {
        "url": "Galway GAA RoH/Independent/Wikipedia club-less + Wikipedia 2022 SHC scored knockout + Fohenagh/AF-first + thin club fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r19",
        "publisher": "Wikipedia / Galway GAA / Irish Independent / Hogan Stand / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r19",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r19: Jason Lohan linked to AF from RoH 1999 Minor B; Fohenagh/Ahascragh historic Minor/Junior fills first. Wikipedia 2023/2024 scored knockout matches. HOLD John Ryan/Michael Headd/Brian Mahoney-O'Mahony collisions. Skip HOLD orphans.",
        }
        existing = []
