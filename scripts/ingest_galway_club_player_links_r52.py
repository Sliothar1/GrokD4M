"""Round 52: Kilconieron U17B Ardrahan + U16 Fr Joe Walsh's scored gaps; Toddie Byrne Cup 2026 Group 4 scored path (Sarsfields); 2025 Feile finals/SF (Fr Joe Walsh's Justin Cheevers champions); Castlegar+Craughwell thin fills (Greg Thomas, Cian Corcoran, Gearoid King, Dylan Carroll, Mark Horan); new club Fr Joe Walsh's; club-less ~79 stay HOLD; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collision notes. Data in data/r52/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r52" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:skehana", "club:mountbellew-moylough", "club:leitrim-galway-historic", "club:ballinasloe", "club:fohenagh-historic", "club:ahascragh-historic", "club:rahoon",
    ]:
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r52" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.kilconierongaaclub.ie/",
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2026-feile-na-ngael",
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2025-feile-na-ngael",
            "https://en.wikipedia.org/wiki/Greg_Thomas_(hurler)",
            "https://en.wikipedia.org/wiki/2025_Galway_Senior_Hurling_Championship",
            "https://www.connachttribune.ie/sport/goal-hungry-st-thomas-eventually-shake-off-castlegar-in-galway-shc-8943899",
            "https://www.tuamherald.ie/2026/08/14/late-drama-as-sarsfields-and-castlegar-draw/",
            "https://connachtgaa.ie/connacht-student-bursary-awards-2026/",
            "https://www.gaa.ie/hurling/news/galway-teams-impressing-bank-ireland-celtic-challenge",
            "https://www.the42.ie/gort-craughwell-galway-senior-hurling-championship-gaa-3705799-Nov2017/"
        ],
        "before": {
        ...
        "priority_club_counts_after": {
            ...
            for c in [
                ...
                "club:portumna", "club:carnmore", "club:rahoon", "club:abbeyknockmoy", "club:kilnadeema-leitrim", "club:ballinderreen", "club:killimor", "club:mullagh", "club:an-spideal", "club:micheal-breathnach", "club:michael-cusacks", "club:oranmore-maree", "club:kinvara", "club:beagh", "club:kilnadeema-leitrim", "club:loughrea", "club:mountbellew-moylough", "club:moycullen", "club:ballinasloe", "club:leitrim-galway-historic", "club:ahascragh-historic", "club:fr-joe-walshs", "club:castlegar", "club:craughwell",
            ]
        },
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r52: Kilconieron U17B Ardrahan + U16 Fr Joe Walsh's scored gaps; Toddie Byrne Cup 2026 G4 scored path; 2025 Feile finals/SF (Fr Joe Walsh's Justin Cheevers champs); Castlegar+Craughwell thin fills; new club Fr Joe Walsh's; club-less ~79 stay HOLD; AF/Fohenagh dense skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "Kilconieron U17B Ardrahan + U16 Fr Joe Walsh's scored gaps; Toddie Byrne 2026 G4; 2025 Feile finals/SF; Castlegar+Craughwell thin fills; Fr Joe Walsh's club; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r52",
        "publisher": "Galway GAA / Athenry GAA / Kilconieron GAA / Connacht Tribune / Wikipedia / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r52",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r52: dense - skipped. Kilconieron U17B Ardrahan + U16 Fr Joe Walsh's; Toddie Byrne 2026 G4; 2025 Feile finals/SF; Castlegar+Craughwell thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
