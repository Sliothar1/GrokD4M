#!/usr/bin/env python3
"""Round 13: Tuam Herald/Irish Examiner club-less links + Wikipedia 2023 AF Senior B scored finals + 2025 knockout matches; thin Killimor/AF-first fills; HOLD Kelly/Brehony/Maloney collisions. Data in data/r13/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r13" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.irishexaminer.com/sport/gaa/arid-10082270.html",
            "https://www.irishexaminer.com/sport/gaa/arid-10121709.html",
            "https://www.irishtimes.com/sport/galway-minors-avenge-defeat-1.1090122",
            ...
            "https://en.wikipedia.org/wiki/Galway_senior_hurling_team_season_2017",
            ...
            "https://www.galwaybayfm.ie/sports/mullagh-wins-county-senior-b-hurling-title-commentary-and-reaction-147361",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r13: AF-first 2023 Senior B scored group+finals; Wikipedia 2025 knockouts; Tuam Herald/Irish Examiner club-less links; thin Killimor + Mullagh/Loughrea fills; HOLD Kelly/Brehony/Maloney/Concannon collisions.",
    }
    ...
    log = {
        "url": "Tuam Herald/Irish Examiner club-less + Wikipedia 2023 AF Senior B + 2025 SHC knockouts",
        "date": "2026-09-06",
        "title": "Galway club-player pack r13",
        "publisher": "Wikipedia / Galway Bay FM / Irish Examiner / Irish Times / Tuam Herald / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r13",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF r13: 2023 Senior B scored group+final draw/replay; Mark Kelly Jr unverified (disambiguated). Bare Kelly/Brehony/Maloney collisions HOLD. Skip HOLD orphans.",
        }
        existing = []
