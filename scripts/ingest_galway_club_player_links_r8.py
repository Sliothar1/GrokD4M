#!/usr/bin/env python3
"""Round 8: club-less links + cited IHC/JHC matches + thin-club fills. Data in data/r8/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r8" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://en.wikipedia.org/wiki/Frank_Burke_(hurler)",
            "https://en.wikipedia.org/wiki/Greg_Kennedy_(hurler)",
            "https://en.wikipedia.org/wiki/Castlegar_GAA",
            "https://en.wikipedia.org/wiki/Galway_Intermediate_Hurling_Championship",
            "https://en.wikipedia.org/wiki/Galway_Junior_A_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2022_Galway_Senior_Hurling_Championship",
            "https://www.gaa.ie/article/aib-all-ireland-club-ihc-impressive-tynagh-abbey-duniry-advance",
            "https://www.gaa.ie/article/galway-shc-final-loughrea-overcome-cappataggle",
            ...
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/2007",
            "https://www.galwaydaily.com/sport/gaa-beaghs-magnificent-seven-shoots-down-moycullen/",
            "https://www.irishmirror.ie/sport/gaa/hurling/hurling-news/michael-donoghue-set-become-new-7055962",
            "https://www.theirishworld.com/the-game-of-their-lives/",
        ...
        "orphan_note": "Remaining orphans stuck without named first+last hurling cites; r8 focused on club-less Wikipedia/GAA links + Wikipedia IHC/JHC scored finals + thin-club fills. New clubs: salthill-knocknacarra, cussane-historic, bearna-na-forbacha.",
    }
    ...
    log = {
        "url": "Wikipedia IHC/JHC + GAA.ie + Galway GAA rolls + Athenry GAA + Galway Daily + Irish Mirror + Irish World + Connacht Tribune",
        "date": "2026-09-06",
        "title": "Galway club-player pack r8",
        "publisher": "Wikipedia / GAA.ie / Galway GAA / Athenry GAA / Galway Daily / Irish Mirror / Irish World / Connacht Tribune / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r8",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF 2026 Connacht Tribune PIHC opener — Padraic Gavin unverified pending Archivist.",
        }
        existing = []
