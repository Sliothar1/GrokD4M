"""Round 23: Wikipedia/Examiner/RoH/Daily club-less links (Mick Gill Ballinderreen; Kevin Coen Ballinderreen; Nigel Shaughnessy Loughrea; Mark Herlihy Kilnadeema-Leitrim); Wikipedia 2018-2019 scored PQF + relegation Match triples; Fohenagh/AF-first (Liam Tully/Liam Cosgrove/Ciaran Cosgrove/Padraig Gavin); thin An Spidéal Junior 1 2013 + Kilnadeema IHC 2013 fills; skip HOLD orphans; new unverified HOLD collisions (Luke Cosgrove vs Liam Cosgrove; Michael Donohue). Data in data/r23/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r23" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:mullagh", "club:portumna", "club:killimor", "club:kiltormer", "club:sylane", "club:oranmore-maree", "club:carnmore", "club:liam-mellows", "club:abbeyknockmoy", "club:an-spideal",
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://en.wikipedia.org/wiki/Mick_Gill",
            "https://en.wikipedia.org/wiki/2018_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2019_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2017_Galway_Senior_Hurling_Championship",
            "https://www.galwaydaily.com/sport/gaa-ballinderreen-end-22-year-wait/",
            "https://www.irishexaminer.com/sport/gaa/arid-41777162.html",
            "https://www.irishexaminer.com/sport/gaa/arid-20443364.html",
            "https://www.galwaygaa.ie/history/2013-hurling-football-roll-of-honour/",
        ],
        "before": {
        ...
        "priority_club_counts_after": {
            ...
            for c in [
                ...
                "club:portumna", "club:carnmore", "club:rahoon", "club:abbeyknockmoy", "club:kilnadeema-leitrim", "club:ballinderreen", "club:killimor", "club:mullagh", "club:an-spideal", "club:kilnadeema-leitrim", "club:loughrea", "club:mountbellew-moylough", "club:moycullen", "club:ballinasloe", "club:leitrim-galway-historic", "club:ahascragh-historic",
            ]
        },
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r23: club-less Mick Gill->Ballinderreen; Kevin Coen->Ballinderreen; Nigel Shaughnessy->Loughrea; Mark Herlihy->Kilnadeema-Leitrim; Wikipedia 2018-2019 scored PQF/relegation + 2017 SF replay; Fohenagh/AF-first Liam Tully/Liam Cosgrove/Ciaran Cosgrove/Padraig Gavin; thin An Spidéal J1 2013 + Kilnadeema IHC 2013 fills; HOLD Luke Cosgrove vs Liam Cosgrove AF; Michael Donohue Kilnadeema club-scoped.",
    }
    ...
    log = {
        "url": "Wikipedia/Examiner/RoH/Daily club-less + AF-first + thin Spidéal/Kilnadeema + 2018-2019 PQF scores",
        "date": "2026-09-06",
        "title": "Galway club-player pack r23",
        "publisher": "Wikipedia / Galway GAA / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r23",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r23: Liam Tully/Liam Cosgrove/Ciaran Cosgrove/Padraig Gavin Irish Examiner 2017 All-Ireland Club IHC final. An Spidéal J1 2013 thin fill; Kilnadeema IHC 2013. Wikipedia 2018-2019 PQF scores. HOLD Luke/Liam Cosgrove; Michael Donohue. HOLD orphans skipped.",
        }
        existing = []
