"""Round 60: 2025 Ask Acorn Junior A/B/C/D/E/F + Junior 1 knockout scored path (QF/SF/finals incl. Junior D final + Junior F final); 2025 IHC PQF/QF/SF; Castle Group U17A/B SF + Minor A/B/C finals; thin-club fills Tynagh-Abbey/Duniry+Castlegar; club-less ~79 stay HOLD (Finnian/Tadgh spelling twins); skip dense AF/Fohenagh player fills (Junior F QF/SF AF score-only); skip HOLD orphans (U17B1 Fr Joe score-only); Jamie Ryan Tynagh vs Loughrea HOLD collision. Data in data/r60/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r60" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r60" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-56-203222",
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-57-203769",
            "https://www.galwaybayfm.ie/sports/weekend-galway-gaa-club-results-58-204265",
            "https://www.galwaybayfm.ie/gaa/the-weekend-galway-gaa-club-results-205361",
            "https://www.galwaybayfm.ie/sports/junior-hurling-championship-finals-reports-204896",
            "https://www.galwaybayfm.ie/gaa/galway-gaa-minor-hurling-finals-reports-204877",
            "https://blog.ballinderreengaa.com/2025/10/newsletter-20251028.html",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan \u2014 2025 U17B1 Padraig Pearses vs Fr Joe Walsh's scored (r60) but no first+last named players; Cois 2017 Justin Cheevers path already ingested. r60: 2025 Ask Acorn Junior A/B/C/D/E/F + Junior 1 knockout + Junior D/F finals + IHC PQF/QF/SF + Minor A/B/C finals + U17A/B SFs; Tynagh+Castlegar thin fills; Jamie Ryan Tynagh/Loughrea HOLD collision; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped (Junior F QF/SF AF score-only); HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2025 Ask Acorn Junior A-F + Junior 1 knockout + Junior D/F finals + IHC PQF/QF/SF + Minor/U17 scored path; Tynagh/Castlegar thin fills; Jamie Ryan HOLD collision",
        "date": "2026-09-07",
        "title": "Galway club-player pack r60",
