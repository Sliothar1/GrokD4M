"""Round 59: 2024 Ask Acorn Junior A/B/C/D/E/F knockout scored path (PQF/QF/SF/rel/finals incl. Junior E final + Junior F final replay); Brooks Minor A/B/B1/C finals+replay+shield; thin-club fills Ardrahan+Castlegar+Salthill; club-less ~79 stay HOLD (Finnian/Tadgh spelling twins); skip dense AF/Fohenagh player fills (Junior F QF AF score-only); skip HOLD orphans (Minor B1 Fr Joe score-only); Enda Concannon Castlegar vs Athenry HOLD collision. Data in data/r59/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r59" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:skehana", "club:mountbellew-moylough", "club:leitrim-galway-historic", "club:ballinasloe", "club:fohenagh-historic", "club:ahascragh-historic", "club:rahoon", "club:fr-joe-walshs", "club:kilbeacanty",
    ]:
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r59" not in note:
    ...
    if by_row.get("player:gerry-kelly", {}).get("club") == "club:athenry":
        set_or_add(seed, pair_index, by_row, "player:gerry-kelly", "hold", False, stats)
        if by_row["player:gerry-kelly"].get("status") == "hold":
            set_or_add(seed, pair_index, by_row, "player:gerry-kelly", "status", "pending_archivist", stats)
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-21-2-174395",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-22-2-174687",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-23-2-174972",
            "https://www.galwaybayfm.ie/sports/weekend-galway-gaa-club-results-9-2-175223",
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-43-178312",
            "https://www.galwaybayfm.ie/gaa/galway-gaa-club-results-8-178936",
            "https://www.galwaybayfm.ie/sports/kinvara-2-4-salthill-knocknacarra-0-8-junior-f-hurling-final-replay-reaction-with-neil-huban-and-steve-moylan-181872",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-84-192310",
            "https://en.wikipedia.org/wiki/2024_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2016_Galway_Senior_Hurling_Championship",
            "https://www.galwaybayfm.ie/sports/hurling-mooncoin-2-26-salthill-knocknacarra-0-11-all-ireland-junior-semi-final-report-and-reaction-107238"
        ],
        "before": {
        ...
        "priority_club_counts_after": {
            ...
            for c in [
                ...
                "club:portumna", "club:carnmore", "club:rahoon", "club:abbeyknockmoy", "club:kilnadeema-leitrim", "club:ballinderreen", "club:killimor", "club:mullagh", "club:an-spideal", "club:micheal-breathnach", "club:michael-cusacks", "club:oranmore-maree", "club:kinvara", "club:beagh", "club:kilnadeema-leitrim", "club:loughrea", "club:mountbellew-moylough", "club:moycullen", "club:ballinasloe", "club:leitrim-galway-historic", "club:ahascragh-historic", "club:fr-joe-walshs", "club:cois-fharraige", "club:castlegar", "club:craughwell",
            ]
        },
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan \u2014 2024 Minor B1 Padraig Pearses vs Fr Joe Walsh's scored (r59) but no first+last named players; Cois 2017 Justin Cheevers path already ingested. r59: Ask Acorn Junior A/B/C/D/E/F knockout + Junior E final + Junior F final replay + Minor A/B/B1/C finals scored path; Ardrahan+Castlegar+Salthill thin fills; Enda Concannon Castlegar/Athenry HOLD collision; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped (Junior F QF AF score-only); HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2024 Ask Acorn Junior A/B/C/D/E/F knockout + Junior E final + Junior F replay + Minor finals scored path; Ardrahan/Castlegar/Salthill thin fills; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r59",
        "publisher": "Galway GAA / Sarsfields GAA / Connacht Tribune / Wikipedia / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r59",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r59: dense player fills skipped (Junior F QF AF vs Ballinasloe score-only). 2024 Junior A-F knockout + Junior E final + Junior F replay + Minor finals; thin Ardrahan/Castlegar/Salthill fills; club-less HOLD; Fr Joe/Cois/orphans skipped.",
        }
        existing = []
