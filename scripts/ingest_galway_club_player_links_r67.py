"""Round 67: College Road orphan break (John Walsh 1892/1893 SHC captain); AF-first Minor B1 Final 2025 named fills (Muldowney/Cunniffe/Ryan Kennedy/Fabian Carroll) + scored Match; Breathnach minor companions; Skehana-MM Michael Lyons; club-less ~79 stay HOLD; remaining HOLD orphans (Claregalway/Kilrickle/Fr Joe/Eyrecourt/Cois/St Coleman's). Data in data/r67/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r67" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r67" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://connachttribune.ie/gavin-holds-his-nerve-to-secure-replay-date-for-ahascragh-fohenagh/",
            "https://www.galwaybayfm.ie/gaa/galway-gaa-minor-hurling-finals-reports-204877",
            "https://www.tuamherald.ie/2026/08/12/strong-start-for-skehana-mountbellew-moylough/",
            "https://hoganstand.com/County/Clare/Article/Index/341673",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/Eyrecourt/Kilrickle/St Coleman's/Fr Joe Walsh's/Cois Fharraige (no first+last named XV cites). r67: College Road orphan broken via John Walsh 1892/1893 SHC captain; AF Minor B1 Final 2025 named fills + scored Match; Breathnach minor companions; Skehana-MM Michael Lyons; club-less ~79 stay HOLD.",
    }
    ...
    log = {
        "url": "College Road John Walsh 1892/1893 SHC captain orphan break; AF Minor B1 Final 2025 named fills + Match; Breathnach minors; Skehana-MM Michael Lyons; club-less HOLD",
        "date": "2026-09-08",
        "title": "Galway club-player pack r67",
        "publisher": "Galway GAA programme (readkong) / Connacht Tribune / Galway Bay FM / Tuam Herald / HoganStand / Wikipedia / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r67",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r67: Minor B1 Final 2025 named fills (Muldowney/Cunniffe/Ryan Kennedy/Fabian Carroll) + scored Match draw vs Breathnach; College Road John Walsh orphan break; club-less HOLD; remaining HOLD orphans unnamed.",
        }
        existing = []
