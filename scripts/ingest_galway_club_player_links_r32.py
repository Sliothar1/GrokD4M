"""Round 32: Wikipedia 2016/2017 Galway SHC scored Match triples (fill thin seasons); link Michael Conneely→Sarsfields + Michael Coen→Ballinderreen (strong first+last); Gort/Portumna club-scoped thin fills after AF check; skip HOLD orphans; new unverified HOLD collisions. Data in data/r32/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r32" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:michael-conneely", "club:sarsfields"),
        ("player:michael-coen", "club:ballinderreen"),
        ("player:mark-mcmahon-gort", "club:gort"),
        ("player:andy-coen-gort", "club:gort"),
        ("player:kaelen-higgins-gort", "club:gort"),
        ("player:albert-mullins-gort", "club:gort"),
        ("player:pakie-lally-gort", "club:gort"),
        ("player:michael-cummins-gort", "club:gort"),
        ("player:jack-commins-gort", "club:gort"),
        ("player:joe-keane-portumna", "club:portumna"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/Michael_Conneely",
            "https://hoganstand.com/county/galway/article/index/88771",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r32: Wikipedia 2016/2017 SHC scored Match pack (thin seasons); Michael Conneely→Sarsfields + Michael Coen→Ballinderreen linked; AF panel already dense — Gort final XV + Portumna Joe Keane club-scoped thin fills; new HOLDs for remaining club-less without strong cites.",
    }
    ...
    log = {
        "url": "Wikipedia 2016-2017 SHC scored Matches / Michael Conneely / HoganStand Michael Coen Ballinderreen",
        "date": "2026-09-06",
        "title": "Galway club-player pack r32",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r32",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r32: AF 2016 IHC + 2017 SB already covered; AF panel dense — no weak AF fills. Wikipedia 2016/2017 SHC scored Match pack; Michael Conneely/Coen links; Gort/Portumna thin fills. HOLD orphans skipped.",
        }
        existing = []
