"""Round 46: Pre-1970 SHC/U-21/MHC/Reeves Cup scored Match triples (Athenry GAA) + 2026 SHC R1/R2 scored Matches (Wikipedia +/- Connacht Tribune); club-less ~79 stay HOLD (no new first+last multi-source clear without twin); Rahoon-Newcastle thin fills from U-20B final; skip HOLD orphans; skip dense AF/Fohenagh; skip dense Tommy Larkins fills; new unverified HOLD collision notes. Data in data/r46/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r46" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r46" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1966",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1968",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1969",
            "https://athenryparishheritage.com/the-athenry-gaa-story-1885-1987/",
            "https://en.wikipedia.org/wiki/2026_Galway_Senior_Hurling_Championship",
            "https://www.connachttribune.ie/sport/tommy-larkins-stun-loughrea-in-galway-senior-hurling-championship-8847539",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r46: pre-1970 SHC (1966 Mullagh-Athenry, 1969 Moycullen-Athenry) + 1968 U-21 SF + 1966/1969 MHC SF/Final + 1966 Reeves Cup final from Athenry GAA/heritage; 2026 SHC R1+R2 scored Matches (Wikipedia; TL-Loughrea also Connacht Tribune); club-less ~79 stay HOLD (no new strong first+last multi-source clear without twin); AF/Fohenagh dense - skipped; Tommy Larkins dense - skipped player fills; Rahoon-Newcastle thin fills (Daithi Carr/Luke Carroll/Dylan Carr/Matthew Murphy/Ciaran Mullins from U-20B final); new HOLD collision notes for Finnian Coone/Stephen Creaven/Joe Keane/Aonghus Dervan/Tadgh Haran/Kerrill Wade.",
    }
    ...
    log = {
        "url": "Pre-1970 SHC/U-21/MHC/Reeves Cup scored Matches / 2026 SHC R1+R2 / Rahoon thin fills / HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r46",
        "publisher": "Athenry GAA / Athenry Parish Heritage / Wikipedia / Connacht Tribune / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r46",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r46: dense - skipped. Pre-1970 SHC/U-21/MHC/Reeves + 2026 SHC R1/R2; Rahoon thin fills; club-less HOLD; orphans skipped; TL dense fills skipped.",
        }
        existing = []
