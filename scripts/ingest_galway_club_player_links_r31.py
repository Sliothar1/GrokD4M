"""Round 31: Wikipedia 2018/2019 Galway SHC scored Match triples (fill thin seasons); Kinvara Junior B 2016 RoH thin fills; Paul Dullaghan Turloughmore club-scoped + Paul Douraghan HOLD; Brendan Lynch Tynagh club-scoped; skip HOLD orphans; new unverified HOLD collisions. Data in data/r31/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r31" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:paul-dullaghan-turloughmore", "club:turloughmore"),
        ("player:brendan-lynch-tynagh-abbey-duniry", "club:tynagh-abbey-duniry"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/Paul_Dullaghan",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r31: Wikipedia 2018/2019 SHC scored Match pack (thin seasons); Kinvara Junior B 2016 RoH thin fills; Paul Dullaghan Turloughmore club-scoped + Paul Douraghan HOLD; Brendan Lynch Tynagh club-scoped; new HOLDs for Mitchell/Fahy/Howe/Hayes/Garvey/Maloney/Lane.",
    }
    ...
    log = {
        "url": "Wikipedia 2018-2019 SHC scored Matches / RoH2016 Kinvara JB / Paul Dullaghan",
        "date": "2026-09-06",
        "title": "Galway club-player pack r31",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r31",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r31: Wikipedia 2018/2019 SHC scored Match pack prioritising AF Senior B seasons already partially covered; Kinvara Junior B 2016 thin fills; Paul Dullaghan Turloughmore. HOLD orphans skipped.",
        }
        existing = []
