"""Round 30: Beagh club history Peter Casserly/Martin Killeen/Albert Moylan; Tommy Larkins RoH medalists + RoH 2016 U21 B + Martin Ryan link; Beagh Junior C 2016 thin fills; Wikipedia 2020/2021 SHC scored Match triples (thin seasons) + 2019 IHC relegation; Padraig Breheny Tynagh club-scoped; skip HOLD orphans; new unverified HOLD collisions (Dervan/Fahy/Breheny). Data in data/r30/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r30" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:peter-casserly", "club:beagh"),
        ("player:martin-killeen", "club:beagh"),
        ("player:albert-moylan", "club:beagh"),
        ("player:martin-ryan", "club:tommy-larkins"),
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/2019_Galway_Intermediate_Hurling_Championship",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r30: Beagh links Peter Casserly/Martin Killeen/Albert Moylan; Martin Ryan->Tommy Larkins; Wikipedia 2020/2021 SHC scored Match pack + 2019 IHC relegation; Tommy Larkins/Beagh thin fills; HOLD Dervan/Fahy/Breheny collisions.",
    }
    ...
    log = {
        "url": "Beagh history/TommyLarkins/RoH2016/Wikipedia 2020-2021 SHC scored Matches + 2019 IHC",
        "date": "2026-09-06",
        "title": "Galway club-player pack r30",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r30",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r30: Wikipedia 2022 SHC scored Match pack (season thin). Tommy Larkins/Cappataggle club-less links. Kilbeacanty/Ballygar thin fills. HOLD Conor/Cormac Diviney; Tom/Frank Donohue. HOLD orphans skipped.",
        }
        existing = []
