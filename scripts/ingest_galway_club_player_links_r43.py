"""Round 43: Pre-1995 Galway SHC knockout scored Match triples (1987 QF + 1988 QF/SF/drawn final + 1989 QF/SF) + Connacht Junior Club HC scored finals gaps (2004/2009/2012–2013/2016–2019/2022–2025) + Bearna year fix; Skehana/MM thin fills; Michael Helebert→Gort multi-source clear; club-less ~81 stay HOLD; skip HOLD orphans; new unverified HOLD collisions. Data in data/r43/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r43" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r43" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1987",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1988",
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1989",
            "https://en.wikipedia.org/wiki/1988_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/Connacht_Junior_Club_Hurling_Championship",
            "https://www.galwaybayfm.ie/sports/skehana-mountbellew-moylough-win-historic-minor-hurling-title-72420",
            "https://www.irishexaminer.com/sport/gaa/arid-10123082.html",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r43: pre-1995 Galway SHC knockout scored Matches (1987 QF + 1988 QF/SF/drawn final + 1989 QF/SF from Athenry GAA / Connacht Tribune / Wikipedia) + Connacht Junior Club HC finals gap pack (2004/2009/2012–2013/2016–2019/2022–2025) + Bearna 2010 year correction; club-less: Michael Helebert multi-source clear to Gort (Keady affair); remaining ~81 stay HOLD; AF/Fohenagh dense — skipped; Skehana/MM thin fills (Harry O'Leary / James Fahy-Hansberry); new HOLD collision notes for Headd/Kelly/Fahy/Hayes/Finnerty/Kenny.",
    }
    ...
    log = {
        "url": "Pre-1995 Galway SHC knockouts (1987–1989) / Connacht Junior Club HC finals / Skehana-MM thin fills / Helebert Gort clear",
        "date": "2026-09-06",
        "title": "Galway club-player pack r43",
        "publisher": "Athenry GAA / Wikipedia / Connacht Tribune / Galway Bay FM / Irish Examiner / Hogan Stand / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r43",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r43: AF/Fohenagh panels dense — skipped. Pre-1995 SHC knockouts + Connacht JHC scored Matches; Skehana/MM thin fills; Helebert→Gort clear. Club-less HOLD; orphans skipped.",
        }
        existing = []
