"""Round 58: 2024 IHC knockout scored gaps (prelim QF/QF/SF/relegation); Ask Acorn Junior B/C/D/F/1 finals+SF path; thin-club fills Castlegar+Tynagh+Ardrahan+Portumna+Kilnadeema+Beagh+Pearses+Oranmore from Wikipedia SHC / GBFM IHC final; club-less ~79 stay HOLD; skip dense AF/Fohenagh; skip HOLD orphans; Kinvara-Turloughmore group score correction; new unverified HOLD collision notes. Data in data/r58/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r58" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r58" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-44-179581",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-77-180890",
            "https://www.galwaybayfm.ie/sports/tynagh-abbey-duniry-wins-county-intermediate-hurling-title-180786",
            ...
            "https://www.galwaybayfm.ie/sports/intermediate-hurling-quarter-final-draw-made-after-killimor-beat-craughwell-175073",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan \u2014 2024 Minor B1 Padraig Pearses vs Fr Joe Walsh's scored but no first+last named players; Cois 2017 Justin Cheevers path already ingested. r58: 2024 IHC prelim QF/QF/SF/relegation + Ask Acorn Junior B/C/D/F/1 finals/SF scored path; Castlegar+Tynagh+Ardrahan+Portumna+Kilnadeema+Beagh+Pearses+Oranmore thin fills; Kinvara-Turloughmore group score corrected; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2024 IHC knockout + Junior B/C/D/F/1 finals/SF scored path; Castlegar/Tynagh/Ardrahan/Portumna/Kilnadeema/Beagh/Pearses/Oranmore thin fills; Kinvara-Turloughmore score fix; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r58",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r58",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r58: dense player fills skipped (Junior F SF Salthill vs AF score only). 2024 IHC knockout + Junior finals/SF path; thin Castlegar/Tynagh/Ardrahan/Portumna/Kilnadeema/Beagh/Pearses/Oranmore fills; club-less HOLD; Fr Joe/Cois/orphans skipped.",
        }
        existing = []
