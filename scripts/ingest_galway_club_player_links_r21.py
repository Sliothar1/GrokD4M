"""Round 21: Wikipedia/RoH/Advertiser club-less links (Vinny Faherty, Richie Devaney Moycullen; John Greene Ardrahan); Wikipedia 2017-2019 scored knockout Match triples; Fohenagh/AF-first (Ahascragh Minor C remaining + 1981 Michael Healy club-scoped); thin Moycullen IHC 2011 / Sylane 1991 / Leitrim 1990 / Mountbellew / Ballinderreen AIJB 2011 fills; skip HOLD orphans (Claregalway, College Road, Eyrecourt, Kilrickle, St Coleman's); new unverified + HOLD collisions (Ciaran O'Connor, Michael Lynskey). Data in data/r21/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r21" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.galwaygaa.ie/history/2011-football-hurling-roll-of-honour/",
            "https://www.advertiser.ie/galway/article/72854/craughwell-aim-to-show-portumna-the-exit-door-on-sunday",
            "https://www.the42.ie/limerick-galway-u21-3555120-Aug2017/",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r21: club-less Vinny Faherty/Richie Devaney->Moycullen; John Greene->Ardrahan; Wikipedia 2017-2019 scored QF/SF/replay matches; Fohenagh/AF-first Ahascragh Minor C remaining + Michael Healy 1981 club-scoped; thin Moycullen IHC 2011 / Sylane / Leitrim / Mountbellew / Ballinderreen fills; HOLD Ciaran O'Connor / Michael Lynskey collisions (plus prior holds).",
    }
    ...
    log = {
        "url": "Wikipedia/RoH/Advertiser club-less + AF-first + thin clubs + 2017-2019 scored knockout",
        "date": "2026-09-06",
        "title": "Galway club-player pack r21",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r21",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r21: Ahascragh Minor C remaining + 1981 Michael Healy club-scoped first. Moycullen IHC 2011 thin fills. Wikipedia 2017-2019 scored knockout. HOLD Ciaran O'Connor/Michael Lynskey. HOLD orphans skipped.",
        }
        existing = []
