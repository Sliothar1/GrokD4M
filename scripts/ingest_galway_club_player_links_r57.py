"""Round 57: 2017 Toddie Byrne/Justin Cheevers/Shield scored Feile path (skip unpublished TB Final); 2024 IHC group scored gaps; Junior A/Junior 1/Connacht SF Ballinasloe path; thin-club fills Ballinasloe+Mullagh+Cappataggle; prefer Cois scored path (orphan; no named players); club-less ~79 stay HOLD; skip dense AF/Fohenagh; skip HOLD orphans; new unverified HOLD collision notes. Data in data/r57/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r57" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r57" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-8-32546",
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2017-feile-na-ngael",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-19-2-170176",
            ...
            "http://www.padraigpearsesgalway.com/2022-senior-cship-round-1/",
            "https://www.connachttribune.ie/sport/hurling/clinical-ballinasloe-complete-the-three-in-a-row-in-junior-1-5594765",
            "https://hoganstand.com/Article/Index/338582",
            "https://billhillwicklow.com/event/connacht-junior-club-hurling-championship-semi-final-2025-ballinasloe-vs-moytura/"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan \u2014 2017 Cois Justin Cheevers Group C scored path added but no first+last named players published. r57: 2017 Toddie Byrne/JC/Shield scored Feile path (TB Final score unpublished skipped); 2024 IHC group gaps; Ballinasloe Junior 1 final + Connacht SF; Ballinasloe+Mullagh+Cappataggle thin fills; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2017 Toddie Byrne/JC/Shield Feile path; 2024 IHC groups; Ballinasloe J1/Connacht SF; Ballinasloe/Mullagh/Cappataggle thin fills; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r57",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r57",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r57: dense player fills skipped. 2017 Toddie Byrne/JC/Shield + Cois GC path; 2024 IHC groups; Ballinasloe/Mullagh/Cappataggle thin fills; club-less HOLD; Cois still orphan (no named players); Fr Joe untouched; orphans skipped.",
        }
        existing = []
