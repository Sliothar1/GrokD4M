"""Round 62: 2025 JFW Div 1/2/3 league finals+SFs + Ask Acorn Junior A/B/C/D/E/F group scored path (results-50/89) + U16 G1 SF; Wikipedia historic SHC 1903/1906/1909 awarded-score fills; thin Ballinasloe/Kiltormer Junior 1 final multi-source fills (Eoin Coleman/Alan Reynolds + Gearoid Markham/Mark Kilkenny/Patrick Cormican/Martin Mannion/Rory Lyons); club-less ~79 stay HOLD; skip dense AF/Fohenagh player fills (Junior C AF score-only); skip HOLD orphans; Michael Kelly + Fr Michael Kilkenny HOLD collision notes. Data in data/r62/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r62" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r62" not in note:
    ...
    for clear_pid, clear_club in [
        ("player:eoin-coleman-ballinasloe", "club:ballinasloe"),
        ("player:alan-reynolds-ballinasloe", "club:ballinasloe"),
        ("player:gearoid-markham-kiltormer", "club:kiltormer"),
        ("player:mark-kilkenny-kiltormer", "club:kiltormer"),
        ("player:patrick-cormican-kiltormer", "club:kiltormer"),
        ("player:martin-mannion-kiltormer", "club:kiltormer"),
        ("player:rory-lyons-kiltormer", "club:kiltormer"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-50-197173",
            "https://www.galwaybayfm.ie/sports/galway-gaa-results-89-196214",
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-59-206399",
            "https://www.galwaybayfm.ie/sports/ballinasloe-3-13-kiltormer-1-12-junior-1-hurling-final-report-reaction-206474",
            "https://www.connachttribune.ie/sport/hurling/clinical-ballinasloe-complete-the-three-in-a-row-in-junior-1-5594765",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan. r62: 2025 Div 1/2/3 league finals+SFs + Junior A-F group + U16 G1 SF; Wikipedia 1903/1906/1909 score fills; Ballinasloe/Kiltormer Junior 1 multi-source thin fills; club-less ~79 stay HOLD; AF dense player fills skipped (Junior C AF score-only); HOLD orphans skipped; Michael Kelly + Fr Michael Kilkenny HOLD collision notes.",
    }
    ...
    log = {
        "url": "2025 Div 1/2/3 league finals+SFs + Junior A-F group + U16 G1 SF; Wikipedia 1903/1906/1909 scores; Ballinasloe/Kiltormer Junior 1 fills; club-less HOLD",
        "date": "2026-09-07",
        "title": "Galway club-player pack r62",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r62",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r62: dense player fills skipped (Junior C AF group score-only). 2025 Div league + Junior A-F group + U16; thin Ballinasloe/Kiltormer Junior 1 fills; club-less HOLD; Fr Joe/Cois/orphans skipped.",
        }
        existing = []
