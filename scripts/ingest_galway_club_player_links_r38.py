"""Round 38: 2009/2010 Galway SHC knockout + Connacht IHC 2010 scored Match triples (thin pre-2013 / IHC gaps); AF/Fohenagh dense — Clarinbridge/Loughrea thin fills from 2010 RoH/teamsheets; club-less stay HOLD (no new strong first+last clears); skip HOLD orphans; new unverified HOLD collisions. Data in data/r38/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r38" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:kevin-conlon-clarinbridge", "club:clarinbridge"),
        ("player:ronan-geraghty-clarinbridge", "club:clarinbridge"),
        ("player:brendan-neylon-clarinbridge", "club:clarinbridge"),
        ("player:noel-conlon-clarinbridge", "club:clarinbridge"),
        ("player:thomas-callanan-clarinbridge", "club:clarinbridge"),
        ("player:brendan-ryder-clarinbridge", "club:clarinbridge"),
        ("player:derek-forde-clarinbridge", "club:clarinbridge"),
        ("player:cathal-obrien-clarinbridge", "club:clarinbridge"),
        ("player:eanna-murphy-clarinbridge", "club:clarinbridge"),
        ("player:gavin-keary-loughrea", "club:loughrea"),
        ("player:nigel-murray-loughrea", "club:loughrea"),
        ("player:vincent-maher-loughrea", "club:loughrea"),
        ("player:tom-hoban-loughrea", "club:loughrea"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.irishtimes.com/sport/portumna-progress-1.656139",
            "https://www.irishexaminer.com/sport/gaa/arid-20133170.html",
            "https://www.irishexaminer.com/sport/gaa/arid-20131263.html",
            "https://www.irishexaminer.com/sport/gaa/arid-20103626.html",
            "https://www.irishexaminer.com/sport/gaa/arid-30479897.html",
            "https://www.advertiser.ie/galway/article/31817/can-portumna-be-stopped",
            "https://www.advertiser.ie/Galway/article/32417/impressive-loughrea-will-face-clarinbridge-in-hurling-final",
            "https://www.advertiser.ie/galway/article/32087/loughrea-and-portumna-return-to-kenny-park-for-replay",
            "https://www.advertiser.ie/Galway/article/17948/gorts-late-flurry-fails-to-stop-portumna",
            "https://en.wikipedia.org/wiki/2010_Galway_Senior_Hurling_Championship",
            "https://www.galwaygaa.ie/history/2010-hurling-football-roll-of-honour/",
            "http://www.padraigpearsesgalway.com/history/",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r38: 2009/2010 Galway SHC knockout scored Match pack (thin pre-2013) + Connacht IHC 2010 Pearses–Ballyhaunis; club-less ~82 stay HOLD (Alan Leech Kinvara/Athenry collision unresolved; spelling twins Tadgh/Kerrill/Shane Maloney); AF/Fohenagh dense — Clarinbridge 2010 RoH + Loughrea 2010 SF thin fills; new HOLDs for Donal Fox/Eanna Murphy/Breheny collisions.",
    }
    ...
    log = {
        "url": "2009/2010 Galway SHC knockout scored Matches / Connacht IHC 2010 Pearses / Clarinbridge 2010 RoH + Loughrea SF thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r38",
        "publisher": "Irish Times / Irish Examiner / Galway Advertiser / Galway GAA RoH / Pádraig Pearses / Wikipedia / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r38",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r38: AF/Fohenagh panels dense — no weak AF fills. 2009/2010 Galway SHC knockout + Connacht IHC 2010 scored Matches; Clarinbridge/Loughrea thin fills. Club-less HOLD; orphans skipped.",
        }
        existing = []
