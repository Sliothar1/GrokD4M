"""Round 26: RoH/BayFM/Wikipedia club-less links (Tony Kirwan AF; Daragh Conneely Liam Mellows; Enda Egan Michael Cusacks; Trevor Cavanagh Tommy Larkins); Wikipedia 2018/2019/2020 AF Senior B scored Match triples + 2018 SB playoffs/relegation; AF-first RoH 2009 Junior C thin fills; skip HOLD orphans; new unverified HOLD collisions (Trevor Kavanagh MHC vs Trevor Cavanagh Tommy Larkins). Data in data/r26/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r26" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:tony-kirwan", "club:ahascragh-fohenagh"),
        ("player:daragh-conneely", "club:liam-mellows"),
        ("player:enda-egan", "club:michael-cusacks"),
        ("player:trevor-cavanagh", "club:tommy-larkins"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaygaa.ie/history/2009-roll-of-honour-football-hurling/",
            "https://www.galwaygaa.ie/history/2007-roll-of-honour-football-hurling/",
            "https://www.galwaybayfm.ie/sports/galway-sides-meet-celtic-challenge-semi-final-34745",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r26: club-less Justin Donnelly/Shane Tierney/Ronan Farrell/Paddy Cormican/Gordan Glynn->Kiltormer; David Greene->Ardrahan; Michael John Quinn->Athenry; Wikipedia 2017 AF Senior B + relegation/SB playoff/PQF scores; AF-first Emmet Brennan; thin Meelick/Eyrecourt Minor B 2016; HOLD Niall Flemming MHC vs Niall Fleming Meelick.",
    }
    ...
    log = {
        "url": "RoH/BayFM/Wikipedia club-less + AF-first Tony Kirwan + RoH 2009 JrC thin fills + 2018/2019/2020 AF SB scores",
        "date": "2026-09-06",
        "title": "Galway club-player pack r26",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r26",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r26: Emmet Brennan Wikipedia 2017 SHC Senior B. Meelick/Eyrecourt Minor B 2016 thin fill. Wikipedia 2017 AF SB + relegation/SB playoff/PQF scores. HOLD Niall Flemming vs Fleming Meelick; Gordon Glynn vs Gordan Kiltormer. HOLD orphans skipped.",
        }
        existing = []
