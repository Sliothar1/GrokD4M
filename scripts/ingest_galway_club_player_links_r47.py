"""Round 47: 2026 SHC Round 3 scored Matches (Final Whistle); pre-1966/1967 Athenry GAA scored JHC/SHC/MHC/U-21/U-16/Reeves/IHC path gaps; Ballygar+Pearses thin fills (Tuam Herald PIHC R1); club-less ~79 stay HOLD; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collision notes. Data in data/r47/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r47" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r47" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.finalwhistle.ie/hurling/galway-shc/",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r47: 2026 SHC Round 3 scored Matches (Final Whistle); pre-1966 Athenry JHC/SHC/MHC + 1959 IHC SF + 1958 JBHC final + 1967 Reeves/MHC/U-21/U-16 scored gaps (Athenry GAA); Ballygar+Padraig Pearses thin fills from Tuam Herald PIHC R1; club-less ~79 stay HOLD; AF/Fohenagh dense skipped; HOLD orphans skipped; new HOLD notes Gordon Glynn/Aonghus Dervan/Sean Glynn/Padraig Breheny/Declan Jennings/Joe Keane.",
    }
    ...
    log = {
        "url": "2026 SHC R3 scored Matches / pre-1966-1967 Athenry scored gaps / Ballygar+Pearses thin fills / HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r47",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r47",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r47: dense - skipped. 2026 SHC R3; pre-1966/1967 Athenry scored gaps; Ballygar+Pearses thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
