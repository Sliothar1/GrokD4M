"""Round 27: RoH/BayFM/Wikipedia/AthenryGAA club-less links (Liam O'Reilly Castlegar; Ronan Reilly Kilbeacanty; Kevin Joyce Clarinbridge); Wikipedia 2021/2022 AF scored Match triples + relegation; AF-first RoH 2010 Minor B thin fills; Michael Cusacks Dylan O'Malley BayFM; skip HOLD orphans; new unverified HOLD collisions (Conor Cunningham MHC vs Colm Cunningham Moycullen; Michael Lyons AF-scoped). Data in data/r27/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r27" / "pack-data.json"
...
def main():
    ...
    for need in [
        ...
        "club:mullagh", "club:portumna", "club:killimor", "club:kiltormer", "club:sylane", "club:oranmore-maree", "club:carnmore", "club:liam-mellows", "club:abbeyknockmoy", "club:an-spideal", "club:micheal-breathnach", "club:michael-cusacks", "club:oranmore-maree",
    ...
    for clear_pid, clear_club in [
        ("player:liam-oreilly", "club:castlegar"),
        ("player:ronan-reilly", "club:kilbeacanty"),
        ("player:kevin-joyce", "club:clarinbridge"),
        ("player:greg-thomas", "club:ballygar"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaygaa.ie/history/2017-club-football-hurling-roll-of-honour/",
            "https://www.galwaygaa.ie/history/2014-football-hurling-roll-of-honour/",
            ...
            "https://clarechampion.ie/history-of-kilbeacanty-gaa/",
            "https://www.galwaybayfm.ie/sports/galway-get-celtic-challenge-under-17-hurling-campaign-off-to-a-winning-start-160691",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r27: club-less Justin Donnelly/Shane Tierney/Ronan Farrell/Paddy Cormican/Gordan Glynn->Kiltormer; David Greene->Ardrahan; Michael John Quinn->Athenry; Wikipedia 2017 AF Senior B + relegation/SB playoff/PQF scores; AF-first Emmet Brennan; thin Meelick/Eyrecourt Minor B 2016; HOLD Niall Flemming MHC vs Niall Fleming Meelick.",
    }
    ...
    log = {
        "url": "RoH/BayFM/Wikipedia/ClareChampion club-less + AF-first RoH 2010 Minor B + 2021/2022 AF scores",
        "date": "2026-09-06",
        "title": "Galway club-player pack r27",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r27",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r27: Emmet Brennan Wikipedia 2017 SHC Senior B. Meelick/Eyrecourt Minor B 2016 thin fill. Wikipedia 2017 AF SB + relegation/SB playoff/PQF scores. HOLD Niall Flemming vs Fleming Meelick; Gordon Glynn vs Gordan Kiltormer. HOLD orphans skipped.",
        }
        existing = []
