"""Round 33: Wikipedia 2015 Galway SHC scored Match triples (fill thin season); link Brendan Keogh→Athenry, Cormac Diviney→Ardrahan, Micheál Donoghue→Clarinbridge (strong first+last); Sarsfields 2015 final XV club-scoped thin fills after AF check; skip HOLD orphans; new unverified HOLD collisions (1923 panel). Data in data/r33/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r33" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:brendan-keogh", "club:athenry"),
        ("player:cormac-diviney", "club:ardrahan"),
        ("player:micheal-donoghue", "club:clarinbridge"),
        ("player:ciaran-dolan-sarsfields", "club:sarsfields"),
        ("player:cathal-murray-sarsfields", "club:sarsfields"),
        ("player:darren-skehill-sarsfields", "club:sarsfields"),
        ("player:diarmuid-murray-sarsfields", "club:sarsfields"),
        ("player:ronan-quinn-sarsfields", "club:sarsfields"),
        ("player:eamon-cleary-sarsfields", "club:sarsfields"),
        ("player:ian-fox-sarsfields", "club:sarsfields"),
        ("player:niall-morrissey-sarsfields", "club:sarsfields"),
        ("player:ian-skehill-sarsfields", "club:sarsfields"),
        ("player:alan-ward-sarsfields", "club:sarsfields"),
    ]:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://en.wikipedia.org/wiki/Brendan_Keogh_(hurler)",
            "https://en.wikipedia.org/wiki/Miche%C3%A1l_Donoghue",
            "https://www.irishexaminer.com/sport/gaa/arid-20243903.html",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r33: Wikipedia 2015 SHC scored Match pack (thin season); Brendan Keogh→Athenry, Cormac Diviney→Ardrahan, Micheál Donoghue→Clarinbridge linked; AF panel already dense — Sarsfields 2015 final XV club-scoped thin fills; new HOLDs for 1923 panel club-less without strong cites.",
    }
    ...
    log = {
        "url": "Wikipedia 2015 SHC scored Matches / Brendan Keogh / Micheál Donoghue / Cormac Diviney Ardrahan",
        "date": "2026-09-06",
        "title": "Galway club-player pack r33",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r33",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r33: AF panel dense — no weak AF fills. Wikipedia 2015 SHC scored Match pack; Brendan Keogh/Cormac Diviney/Micheál Donoghue links; Sarsfields 2015 final XV thin fills. HOLD orphans skipped.",
        }
        existing = []
