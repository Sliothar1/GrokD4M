"""Round 40: Pre-2008 Galway SHC knockout scored Match triples (2003–2007) + Connacht IHC 2005/2006/2007 finals (IHC gaps); Michael Cusacks U-20B + Killimordaly 2006 RoH thin fills; club-less stay HOLD; skip HOLD orphans; new unverified HOLD collisions. Data in data/r40/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r40" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r40" not in note:
    ...
    for clear_pid, clear_club in [
        ("player:cian-oloughlin-michael-cusacks", "club:michael-cusacks"),
        ("player:calum-prendergast-michael-cusacks", "club:michael-cusacks"),
        ("player:eoin-fahey-michael-cusacks", "club:michael-cusacks"),
        ("player:sean-mcloughlin-michael-cusacks", "club:michael-cusacks"),
        ("player:darren-hynes-michael-cusacks", "club:michael-cusacks"),
        ("player:clement-earls-killimordaly", "club:killimordaly"),
        ("player:johnny-duane-killimordaly", "club:killimordaly"),
        ("player:fergal-duane-killimordaly", "club:killimordaly"),
        ("player:gary-earls-killimordaly", "club:killimordaly"),
        ("player:adrian-lawless-killimordaly", "club:killimordaly"),
        ("player:martin-corcoran-killimordaly", "club:killimordaly"),
        ("player:cathal-daly-killimordaly", "club:killimordaly"),
        ("player:iomar-creaven-killimordaly", "club:killimordaly"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaybayfm.ie/sports/galway-gaa-club-teams-of-the-2000s-announced-next-monday-79842",
            "https://www.independent.ie/sport/gaelic-games/hurling/galway-loughrea-lay-low-champions-athenry-as-cloonan-sees-red/25962891.html",
            "https://www.irishexaminer.com/sport/gaa/arid-30228333.html",
            "https://en.wikipedia.org/wiki/2006%E2%80%9307_All-Ireland_Intermediate_Club_Hurling_Championship",
            "https://en.wikipedia.org/wiki/Connacht_Intermediate_Club_Hurling_Championship",
            "https://www.galwaygaa.ie/history/2006-roll-of-honour-hurling-football/",
            "https://connachttribune.ie/michael-cusacks-claim-county-crown-with-impressive-display/",
            "https://www.galwaybayfm.ie/sports/michael-cusacks-wins-county-u20-b-hurling-title-commentary-and-reaction-202531",
            "https://www.independent.ie/sport/gaelic-games/hurling/dubliner-and-corkman-lead-london-club-to-title/26270038.html",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r40: pre-2008 Galway SHC knockout scored Match pack (2003–2007 QF/SF from BayFM + Independent 2005 SF) + Connacht IHC 2005/2006/2007 finals; club-less ~82 stay HOLD (no new strong multi-source clears; Benny Lawless Menlo Emmetts 2006 RoH single-cut insufficient); AF/Fohenagh dense — skipped; Michael Cusacks U-20B + Killimordaly 2006 RoH thin fills; new HOLDs for Eoin Fahy/Fahey dual-stamp collisions.",
    }
    ...
    log = {
        "url": "Pre-2008 Galway SHC knockout scored Matches (2003-2007) / Connacht IHC 2005-07 / Michael Cusacks + Killimordaly thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r40",
        "publisher": "Galway Bay FM / Irish Independent / Irish Examiner / Galway GAA RoH / Wikipedia / Connacht Tribune / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r40",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r40: AF/Fohenagh panels dense — no weak AF fills. Pre-2008 SHC knockouts + Connacht IHC 2005-07 scored Matches; Michael Cusacks/Killimordaly thin fills. Club-less HOLD; orphans skipped.",
        }
        existing = []
