"""Round 61: 2025 Ask Acorn Junior A/B/C/D/E knockout scored path + IHC group scores; Castle Group U17A/B/B1/C knockout + U17B1 SFs; Wikipedia historic SHC final score fills (1895-1932 gaps + 1959/60/63 alias stubs); thin-club Michael Power Tynagh + strong multi-source Jarlath McEvoy/Tommy Fleming Meelick IHC final + Gort/Moycullen Wikipedia fills; club-less ~79 stay HOLD; skip dense AF/Fohenagh player fills (Junior C/U17B1 AF score-only); skip HOLD orphans; Michael Kelly bare-row HOLD collision note. Data in data/r61/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r61" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r61" not in note:
    ...
    for clear_pid, clear_club in [
        ...
        ("player:michael-power-tynagh-abbey-duniry", "club:tynagh-abbey-duniry"),
        ("player:jarlath-mcevoy-meelick-eyrecourt", "club:meelick-eyrecourt"),
        ("player:tommy-fleming-meelick-eyrecourt", "club:meelick-eyrecourt"),
        ("player:darren-grealish-gort", "club:gort"),
        ("player:ben-odonovan-gort", "club:gort"),
        ("player:mark-bradley-moycullen", "club:moycullen"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-54-202237",
            "https://www.galwaybayfm.ie/sports/weekend-galway-gaa-club-results-55-202778",
            "https://www.galwaybayfm.ie/gaa/weekend-galway-gaa-club-results-57-203769",
            "https://en.wikipedia.org/wiki/Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/2025_Galway_Senior_Hurling_Championship",
            "https://www.galwaybayfm.ie/index.php/sports/meelick-eyrecourt-1-16-kinvara-0-16-intermediate-hurling-final-report-reaction-206455",
            "https://www.connachttribune.ie/sport/hurling/meelick-eyrecourt-finish-in-a-blaze-of-glory-to-end-famine-5594766"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's + Cois Fharraige still orphan \u2014 U17B1 Fr Joe path score-only (already in). r61: 2025 Junior A/B/C/D/E knockout + IHC group + U17A/B/B1/C knockout + U17B1 SFs; Wikipedia historic SHC score fills; Tynagh Michael Power + Meelick IHC final multi-source Jarlath McEvoy/Tommy Fleming + Gort/Moycullen Wikipedia fills; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped (Junior C/U17B1 AF score-only); HOLD orphans skipped; Michael Kelly bare HOLD collision.",
    }
    ...
    log = {
        "url": "2025 Junior A/B/C/D/E knockout + IHC group + U17A/B/B1/C knockout + U17B1 SFs; Wikipedia historic SHC scores; Tynagh/Meelick/Gort/Moycullen fills; club-less HOLD",
        "date": "2026-09-07",
        "title": "Galway club-player pack r61",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r61",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r60: dense player fills skipped (Junior F QF/SF AF score-only). 2025 Junior A-F + Junior 1 knockout + Junior D/F finals + IHC PQF/QF/SF + Minor/U17; thin Tynagh/Castlegar fills; club-less HOLD; Fr Joe/Cois/orphans skipped.",
        }
        existing = []
