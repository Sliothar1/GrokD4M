"""Round 53: 2025 Justin Cheevers G2 scored path + Toddie Byrne/Cheevers 2025 SFs; Pearses U16A1 2021 Fr Joe Walsh's scored gap; Pearses+Craughwell thin fills (Orin Burke, Ronan Hynes, James Queeney, Patrick Monaghan, Oisin Quirke); prefer Fr Joe Walsh's (match cite; no named players); club-less ~79 stay HOLD; skip dense AF/Fohenagh player fills; skip HOLD orphans; new unverified HOLD collision notes. Data in data/r53/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r53" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r53" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "http://www.padraigpearsesgalway.com/u16-a1-round-2-pearses-2-16-fr-joe-walshs-0-12/",
            ...
            "https://www.galwaydaily.com/sport/galway-gaa-padraig-pearses-under-13-b-hurling-champions/",
            "https://www.galwaydaily.com/sport/galway-gaa-match-report-liam-mellows-0-17-craughwell-0-11/"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's still orphan — U16A1 2021 scored match added but report names no Fr Joe first+last players. r53: 2025 Justin Cheevers G2 + Toddie/Cheevers SFs scored gaps; Pearses+Craughwell thin fills; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2025 Justin Cheevers G2 + Toddie/Cheevers SFs scored gaps; Pearses U16A1 Fr Joe Walsh's 2021; Pearses+Craughwell thin fills; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r53",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r53",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r53: dense player fills skipped. 2025 Justin Cheevers G2 scored path (AF as opponent only); Toddie/Cheevers 2025 SFs; Pearses U16A1 Fr Joe Walsh's; Pearses+Craughwell thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
