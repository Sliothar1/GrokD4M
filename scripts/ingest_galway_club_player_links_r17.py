"""Round 17: Galway GAA Roll of Honour club-less links + Wikipedia 2023 scored SHC matches; Fohenagh/AF-first historic fills + thin Moycullen/Killimor/Athenry/Oranmore/Turloughmore/Abbeyknockmoy/Carnmore/Rahoon/Sylane/ME fills; HOLD Declan Jenning(s)/Brian Murphy/Conor Burke/Joe Keane/John Conroy collisions. Data in data/r17/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r17" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r17: club-less Roll of Honour links (Jason Lohan AF; Conneely/Sarsfields; Connolly/Costello Castlegar; Greaney/Burke Turloughmore; Headds St Thomas; Turley/Hogan ME; Maher Loughrea; Whirskey Craughwell; Brady/Keane Athenry; Kelly/McGraths Sarsfields; Madden/Donoghue Clarinbridge; Coen Mullagh; Broderick Killimor; Earls Killimordaly); Wikipedia 2023 SHC scored group/knockout + Senior B matches; Fohenagh/Ahascragh historic fills first; thin Moycullen/Killimor/Athenry/Oranmore/Turloughmore/Abbeyknockmoy/Carnmore/Rahoon/Sylane/ME fills; HOLD Declan Jenning(s)/Brian Murphy/Conor Burke/Joe Keane/John Conroy collisions.",
    }
    ...
    log = {
        "url": "Galway GAA Roll of Honour club-less + Wikipedia 2023 scored SHC + Fohenagh/AF-first historic + thin club fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r17",
        "publisher": "Wikipedia / Galway GAA / Tuam Herald / Connacht Tribune / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r17",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r17: Jason Lohan linked to AF from RoH 1999 Minor B; Fohenagh/Ahascragh historic Minor/Junior fills first. Wikipedia 2023 scored matches. HOLD Jenning(s)/Murphy/Burke/Keane/Conroy collisions. Skip HOLD orphans.",
        }
        existing = []
