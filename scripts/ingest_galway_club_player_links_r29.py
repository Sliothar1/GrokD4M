"""Round 29: The42/SeamusJKing Paul Loughnane→Cappataggle; Tommy Larkins RoH Noel Murphy/Tony Brehony/Frank Donohue/Gerry Kennedy; Wikipedia 2022 SHC scored Match triples (thin season) + 2023 SB Group 2 gaps; Kilbeacanty RoH 2014 + Ballygar RoH 2018 thin fills; skip HOLD orphans; new unverified HOLD collisions (Conor vs Cormac Diviney; Tom vs Frank Donohue). Data in data/r29/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r29" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:paul-loughnane", "club:cappataggle"),
        ("player:noel-murphy", "club:tommy-larkins"),
        ("player:tony-brehony", "club:tommy-larkins"),
        ("player:frank-donohue", "club:tommy-larkins"),
        ("player:gerry-kennedy", "club:tommy-larkins"),
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.the42.ie/galway-hurling-james-skehill-5317542-Jan2021/",
            "https://www.seamusjking.com/sjk-articles/2017/4/3/ltspan-classposttitlegtnew-york-gaa-senior-hurling-finalltspangt-tipperary-yearbook-2019-pg-45",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r29: Paul Loughnane->Cappataggle; Noel Murphy/Tony Brehony/Frank Donohue/Gerry Kennedy->Tommy Larkins; Wikipedia 2022 SHC scored Match pack + 2023 SB Group 2 gaps; thin Kilbeacanty/Ballygar; HOLD Conor vs Cormac Diviney; Tom vs Frank Donohue.",
    }
    ...
    log = {
        "url": "The42/TommyLarkins/RoH/Wikipedia 2022 SHC scored Matches + club-less Tommy Larkins/Cappataggle",
        "date": "2026-09-06",
        "title": "Galway club-player pack r29",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r29",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r29: Wikipedia 2022 SHC scored Match pack (season thin). Tommy Larkins/Cappataggle club-less links. Kilbeacanty/Ballygar thin fills. HOLD Conor/Cormac Diviney; Tom/Frank Donohue. HOLD orphans skipped.",
        }
        existing = []
