"""Round 54: 2023 Toddie Byrne/Justin Cheevers/Shield scored Féile path + Cois Fharraige club; Craughwell thin fills (Lucas Keane, Adam Clarke, Iarlaith Leen) + Pearses Luke Mitchell; prefer Fr Joe Walsh's (2023 Cheevers group noted; no named players/group scores); club-less ~79 stay HOLD; skip dense AF/Fohenagh player fills; skip HOLD orphans; new unverified HOLD collision notes. Data in data/r54/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r54" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r54" not in note:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://www.sarsfields-gaa.com/juvenile-hurling-club/2023-feile-na-ngael",
            "https://en.wikipedia.org/wiki/2025_Galway_Senior_Hurling_Championship",
            "https://www.connachttribune.ie/sport/craughwell-edge-past-liam-mellows-in-tight-galway-shc-group-two-clash-8939262",
            "https://connachttribune.ie/clarke-the-hero-as-craughwell-snatch-victory-in-marathon-tie/",
            "https://www.connachttribune.ie/sport/evan-niland-leads-clarinbridge-to-victory-over-craughwell-in-galway-shc-8881964",
            "http://www.padraigpearsesgalway.com/2022-senior-cship-round-4-2/",
            "https://galwaypulse.com/2025/10/07/galway-senior-hurling-championship-recap/"
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). Fr Joe Walsh's still orphan — 2023 Justin Cheevers Group 2 included Fr Joe but no published group scores or first+last named players; Cois Fharraige created as match-side club (still may be orphan until named players). r54: 2023 Toddie/Cheevers/Shield scored Féile path; Craughwell+Pearses thin fills; club-less ~79 stay HOLD; AF/Fohenagh dense player fills skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "2023 Toddie Byrne/Justin Cheevers/Shield scored Féile path; Cois Fharraige club; Craughwell+Pearses thin fills; HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r54",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r54",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r54: dense player fills skipped. 2023 Toddie Byrne Shield scored path (AF as opponent only); Cois Fharraige club; Craughwell+Pearses thin fills; club-less HOLD; Fr Joe orphan (no named players); orphans skipped.",
        }
        existing = []
