"""Round 37: 2011 Galway SHC knockout scored Match triples (fill thin 2011); link Enda Fahey→Michael Cusacks (strong first+last); AF/Fohenagh dense — Clarinbridge/Gort/St Thomas thin fills from 2011 teamsheets; skip HOLD orphans; new unverified HOLD collisions. Data in data/r37/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r37" / "pack-data.json"
...
def main():
    ...
    for clear_pid, clear_club in [
        ("player:enda-fahey", "club:michael-cusacks"),
        ("player:mark-kerins", "club:clarinbridge"),
        ("player:peter-cummins-gort", "club:gort"),
        ("player:sylvie-og-linnane-gort", "club:gort"),
        ("player:sean-forde-gort", "club:gort"),
        ("player:shane-mannion-clarinbridge", "club:clarinbridge"),
        ("player:shane-burke-clarinbridge", "club:clarinbridge"),
        ("player:jamie-cannon-clarinbridge", "club:clarinbridge"),
        ("player:james-barrett-st-thomas", "club:st-thomas"),
        ("player:robert-murray-st-thomas", "club:st-thomas"),
        ("player:conor-forde-clarinbridge", "club:clarinbridge"),
    ]:
    ...
    pack = {
        ...
        "generated_at": now,
        "sources": [
            "https://en.wikipedia.org/wiki/2011_Galway_Senior_Hurling_Championship",
            "https://en.wikipedia.org/wiki/Mark_Kerins",
            "https://www.irishexaminer.com/sport/gaa/arid-20170143.html",
            "https://www.irishexaminer.com/sport/gaa/arid-20170895.html",
            "https://www.irishexaminer.com/sport/gaa/arid-20172312.html",
            "https://www.irishtimes.com/sport/late-cummins-goal-proves-decisive-1.630761",
            "https://www.advertiser.ie/galway/article/45052/clarinbridge-still-favourites-to-advance",
            "https://www.advertiser.ie/galway/article/45053/healy-points-the-way-for-craughwell",
            "https://www.advertiser.ie/galway/article/45948/clarinbridge-ease-past-craughwell-to-reach-another-county-final",
            "https://www.advertiser.ie/galway/article/46194/gort-crowned-county-senior-hurling-champions-for-2011",
            "https://www.advertiser.ie/Galway/article/94396/minor-hurlers-pip-kilkenny-for-all-ireland-final-spot",
            "https://www.the42.ie/galway-hurling-evan-niland-nuig-fitzgibbon-cup-ul-4456745-Jan2019/",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r37: 2011 Galway SHC knockout scored Match pack (thin 2011); Enda Fahey→Michael Cusacks linked (Advertiser/The42); AF/Fohenagh dense — Clarinbridge/Gort/St Thomas thin fills from 2011 teamsheets; Mark Kerins Wikipedia Clarinbridge; new HOLDs for spelling/id collisions.",
    }
    ...
    log = {
        "url": "2011 Galway SHC knockout scored Matches / Enda Fahey Michael Cusacks / Mark Kerins Clarinbridge / Gort St Thomas thin fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r37",
        "publisher": "Wikipedia / Galway Advertiser / Irish Examiner / Irish Times / The42 / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r37",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r37: AF/Fohenagh panels dense — no weak AF fills. 2011 Galway SHC knockout scored Match pack; Enda Fahey→Michael Cusacks; Clarinbridge/Gort/St Thomas thin fills. HOLD orphans skipped.",
        }
        existing = []
