"""Round 18: Galway GAA Roll of Honour club-less links + Wikipedia 2023/2024 scored SHC matches; Fohenagh/AF-first historic fills + thin Annaghdown/Ballinasloe/Carnmore/Rahoon/Sylane/Kiltormer fills; HOLD John Ryan/Michael Headd/Brian Mahoney-O'Mahony collisions. Data in data/r18/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r18" / "pack-data.json"
...
def main():
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.athenrygaa.ie/index.php/history-photo-gallery/1994",
            "http://www.advertiser.ie/galway/article/74584/hurling-stars-to-fundraise-for-new-mental-health-awareness-group",
        ],
        "before": {
        ...
        "orphan_note": "Remaining HOLD orphans unchanged (Claregalway/College Road/Eyrecourt/Kilrickle/Skehana/St Coleman's) — skip unless first+last hurling cite. r18: club-less Roll of Honour/Athenry/Advertiser links (Canning Portumna; Walsh Carnmore; Healy/Higgins Athenry; Spellman Clarinbridge; Darcy Moycullen; O'Brien Pearses; Burke Kilconieron; Larkin ME; Linnane Gort); Wikipedia 2023/2024 SHC scored knockout+relegation+Senior B matches; Fohenagh/Ahascragh historic fills first; thin Annaghdown/Ballinasloe/Carnmore/Rahoon/Sylane/Kiltormer fills; HOLD John Ryan/Michael Headd/Brian Mahoney–O'Mahony collisions (plus prior holds).",
    }
    ...
    log = {
        "url": "Galway GAA Roll of Honour club-less + Wikipedia 2023/2024 scored SHC knockout + Fohenagh/AF-first historic + thin club fills",
        "date": "2026-09-06",
        "title": "Galway club-player pack r18",
        "publisher": "Wikipedia / Galway GAA / Athenry GAA / Galway Advertiser / HurlingWiki",
        "processed_at": now,
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r18",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r18: Jason Lohan linked to AF from RoH 1999 Minor B; Fohenagh/Ahascragh historic Minor/Junior fills first. Wikipedia 2023/2024 scored knockout matches. HOLD John Ryan/Michael Headd/Brian Mahoney-O'Mahony collisions. Skip HOLD orphans.",
        }
        existing = []
