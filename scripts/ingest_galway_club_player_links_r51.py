"""Round 51: Kilconieron U14/U17B scored gaps + Feile Gallimh Toddie Byrne/Justin Cheevers scored finals/SFs (Sarsfields page); Ardrahan thin fills (Iain Lynskey, Cian Callanan, Alex O'Flynn, Liam Forde — Wiki+CT); club-less ~79 stay HOLD; skip HOLD orphans; skip dense AF/Fohenagh; new unverified HOLD collision notes. Data in data/r51/pack-data.json."""
...
DATA_PATH = ROOT / "data" / "r51" / "pack-data.json"
...
def main():
    ...
    for pid, hnote in hold_notes.items():
        ...
        if hnote not in note and "HOLD r51" not in note:
    ...
    pack = {
        ...
        "sources": [
            ...
            "https://www.connachttribune.ie/sport/ardrahan-clinch-division-two-title-after-extra-time-battle-with-gort-8798258",
        ...
        "orphan_note": "Remaining HOLD orphans: Claregalway/College Road/Eyrecourt/Kilrickle/St Coleman's (skipped; no first+last hurling cite). r51: Kilconieron U14/U17B scored gaps + Feile Gallimh Toddie Byrne Shield/Justin Cheevers Cup finals+SFs (Sarsfields); Ardrahan thin fills (Iain Lynskey, Cian Callanan, Alex O'Flynn, Liam Forde); club-less ~79 stay HOLD (collision notes); AF/Fohenagh dense skipped; HOLD orphans skipped.",
    }
    ...
    log = {
        "url": "Kilconieron U14/U17B scored gaps + Feile Toddie Byrne/Justin Cheevers scored finals/SFs / Ardrahan thin fills (Wiki+CT) / HOLD collisions",
        "date": "2026-09-07",
        "title": "Galway club-player pack r51",
    ...
    if fohenagh_new or fohenagh_linked:
        q = {
            "batch": "fohenagh-club-links-r51",
            "ruled_at": now,
            "clear_links": fohenagh_linked,
            "unverified_new": fohenagh_new,
            "note": "AF/Fohenagh r51: dense - skipped. Kilconieron U14/U17B scored gaps; Feile Toddie Byrne/Justin Cheevers scored finals/SFs; Ardrahan thin fills; club-less HOLD; orphans skipped.",
        }
        existing = []
